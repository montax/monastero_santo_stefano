...
(self.webpackChunkcube = self.webpackChunkcube || []).push([[736], {
    711: function(t) {
        t.exports = function(t) {
            ...
            i(6))
              ...
              , g = function() {
                if (arguments.length > 0 && void 0 !== arguments[0] && arguments[0] && (f = !0),
                f)
                    return p = (0,
                    h.default)(p, m),
                    (0,
        ...
        , , , , , function(t, e) {
            (function(e) {
                ...
                function i(t, e, i) {
                    ...
                    var d, p, f, m, g, y, v = 0, E = !1, x = !1, k = !0;
                ...
                t.exports = function(t, e, s) {
                    ...
                    if ("function" != typeof t)
                        throw new TypeError(a);
                    return n(s) && (o = "leading"in s ? !!s.leading : o,
        ...
        , function(t, e) {
            (function(e) {
                ...
                function s(t) {
                    ...
                    t = t.replace(c, "");
                    var s = h.test(t);
                    return s || d.test(t) ? p(t.slice(2), s ? 2 : 8) : u.test(t) ? a : +t
                }
                ...
                t.exports = function(t, e, n) {
                    ...
                    var d, p, f, m, g, y, _ = 0, E = !1, x = !1, k = !0;
                    if ("function" != typeof t)
    ...
    765: t=>{
        var e, i, n, s, o, r, a, l, c, u, h, d, p, f, m, g, y, v, b, w, _, E, x, k, T, C, S, A, L, P, O, M, N, I = [], D = {}, j = "appendChild", H = "createElement", F = "removeChild";
        function z() {
            var t = e.getBoundingClientRect()
              ...
              , r = t.width
              , a = t.height;
            return "transform:translate3D(" + (o - (n.clientWidth - r) / 2) + "px, " + (i - (n.clientHeight - a) / 2) + "px, 0) scale3D(" + e.clientWidth / s.clientWidth + ", " + e.clientHeight / s.clientHeight + ", 0)"
        }
        function R(t) {
            var e = P.length - 1;
            if (!p) {
                if (t > 0 && L === e || t < 0 && !L) {
                    if (!N.loop)
                        return X(o, ""),
                        void setTimeout(X, 9, o, "animation:" + (t > 0 ? "bpl" : "bpf") + " .3s;transition:transform .35s");
                    L = t > 0 ? -1 : e + 1
                }
                if ([(L = Math.max(0, Math.min(L + t, e))) - 1, L, L + 1].forEach((function(t) {
        ...
        function B(t) {
            ...
            if (i.error)
                ...
                X(o = s = D[L], "animation:" + (t > 0 ? "bpfl" : "bpfr") + " .35s;transition:transform .35s"),
        ...
        function $() {
            var t, e, i = .95 * window.innerHeight, n = .95 * window.innerWidth, s = i / n, o = N.dimensions || [1920, 1080], r = o[0], a = o[1], c = a / r;
            c > s ? e = (t = Math.min(a, i)) / c : t = (e = Math.min(r, n)) * c,
            l.style.cssText += "width:" + e + "px;height:" + t + "px;"
        }
        function q(t) {
            ~[1, 4].indexOf(s.readyState) ? (Y(),
            setTimeout((function() {
                s.play()
            }
            ), 99)) : s.error ? Y(t) : f = setTimeout(q, 35, t)
        }
        function W(t) {
            N.noLoader || (t && X(m, "top:" + e.offsetTop + "px;left:" + e.offsetLeft + "px;height:" + e.clientHeight + "px;width:" + e.clientWidth + "px"),
        ...
        function Y(t) {
            ...
            "string" == typeof t)
                return K(),
                N.onError ? N.onError() : alert("Error: The requested " + t + " could not be loaded.");
            x && U(u),
            s.style.cssText += z(),
        ...
        function Q(t) {
            var e = t ? t.target : n
              , i = [g, b, r, a, y, A, S, m];
            e.blur(),
            E || ~i.indexOf(e) || (s.style.cssText += z(),
        ...
        function K() {
            if ((s === l ? c : s).removeAttribute("src"),
            document.body[F](n),
            n[F](s),
            X(n, ""),
            X(s, ""),
        ...
        t.exports = function(t) {
            ...
            return i || function() {
                ...
                function e(t) {
                    ...
                    e.innerHTML = '<svg viewBox="0 0 48 48"><path d="M28 24L47 5a3 3 0 1 0-4-4L24 20 5 1a3 3 0 1 0-4 4l19 19L1 43a3 3 0 1 0 4 4l19-19 19 19a3 3 0 0 0 4 0v-4L28 24z"/></svg>',
                    e
                }
                function u(t, e) {
                    var i = document[H]("button");
                    return i.className = "bp-lr",
                    i.innerHTML = '<svg viewBox="0 0 129 129" height="70" fill="#fff"><path d="M88.6 121.3c.8.8 1.8 1.2 2.9 1.2s2.1-.4 2.9-1.2a4.1 4.1 0 0 0 0-5.8l-51-51 51-51a4.1 4.1 0 0 0-5.8-5.8l-54 53.9a4.1 4.1 0 0 0 0 5.8l54 53.9z"/></svg>',
                    X(i, e),
                ...
                m.innerHTML = '<svg viewbox="0 0 32 32" fill="#fff" opacity=".8"><path d="M16 0a16 16 0 0 0 0 32 16 16 0 0 0 0-32m0 4a12 12 0 0 1 0 24 12 12 0 0 1 0-24" fill="#000" opacity=".5"/><path d="M16 0a16 16 0 0 1 16 16h-4A12 12 0 0 0 16 4z"/></svg>',
                ...
                ,
                X(c, "border:0;position:absolute;height:100%;width:100%;left:0;top:0"),
                l[j](c),
                o.onload = Y,
                o.onerror = Y.bind(null, "image"),
                ...
                document.addEventListener("keydown", (function(t) {
                    _ && ~[37, 38, 39, 40].indexOf(t.keyCode) && t.preventDefault()
                }
                )),
                document.addEventListener("focus", (function(t) {
                    w && !n.contains(t.target) && (t.stopPropagation(),
                    h.focus())
                }
                ), !0),
                i = !0
            ...
            t.gallery ? function(t, i) {
                var r = N.galleryAttribute || "data-bp";
                if (Array.isArray(t))
                    P = t,
                    v = t[L = i || 0].caption;
                else {
                    var a = (P = [].slice.call("string" == typeof t ? document.querySelectorAll(t + " [" + r + "]") : t)).indexOf(e);
                    L = 0 === i || i ? i : -1 !== a ? a : 0,
                    P = P.map((function(t) {
                        return {
                            el: t,
                ...
                n[j](A))) : P = !1,
                (s = o).src = u
            }(t.gallery, t.position) : d || t.iframeSrc ? (s = l,
            z = "https://",
            B = "autoplay=1",
            N.ytSrc ? D = z + "www.youtube" + (N.ytNoCookie ? "-nocookie" : "") + ".com/embed/" + d + "?html5=1&rel=0&playsinline=1&" + B : N.vimeoSrc ? D = z + "player.vimeo.com/video/" + d + "?" + B : N.iframeSrc && (D = N.iframeSrc),
            X(m, ""),
            l[j](m),
            c.src = D,
            $(),
            setTimeout(Y, 9)) : t.imgSrc ? (x = !0,
            u = t.imgSrc,
            !~I.indexOf(u) && W(!0),
            (s = o).src = u) : t.audio ? (W(!0),
            (s = a).src = t.audio,
            q("audio file")) : t.vidSrc ? (W(!0),
            t.dimensions && X(r, "width:" + t.dimensions[0] + "px"),
            E = t.vidSrc,
            Array.isArray(E) ? (s = r.cloneNode(),
            ...
            q("video")) : (s = o).src = "IMG" === e.tagName ? e.src : window.getComputedStyle(e).backgroundImage.replace(/^url|[(|)|'|"]/g, ""),
            n[j](s),
            document.body[j](n),
            {
                close: Q,
    ...
    169: (t,e,i)=>{
            ...
            fn: function(t) {
                ...
                Object.keys(e.elements).forEach((function(t) {
                    var i = e.styles[t] || {}
                      , n = e.attributes[t] || {}
                      , s = e.elements[t];
                    O(s) && A(s) && (Object.assign(s.style, i),
            ...
            effect: function(t) {
                ...
                function() {
                    Object.keys(e.elements).forEach((function(t) {
                        ...
                        O(n) && A(n) && (Object.assign(n.style, o),
        ...
        function B(t) {
            return "html" === A(t) ? t : t.assignedSlot || t.parentNode || (M(t) ? t.host : null) || R(t)
        }
        function $(t) {
        ...
        function q(t) {
            for (var e = L(t), i = $(t); i && z(i) && "static" === F(i).position; )
                i = $(i);
            return i && ("html" === A(i) || "body" === A(i) && "static" === F(i).position) ? e : i || function(t) {
                var e = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox");
                if (-1 !== navigator.userAgent.indexOf("Trident") && O(t) && "fixed" === F(t).position)
                    return null;
                for (var i = B(t); O(i) && ["html", "body"].indexOf(A(i)) < 0; ) {
                    var n = F(i);
        ...
        const G = {
            ...
            phase: "main",
            fn: function(t) {
                var e, i = t.state, n = t.name, l = t.options, u = i.elements.arrow, h = i.modifiersData.popperOffsets, d = I(i.placement), p = W(d), f = [a, r].indexOf(d) >= 0 ? "height" : "width";
                if (u && h) {
                    var m = function(t, e) {
            ...
            effect: function(t) {
                ...
                null != n && ("string" != typeof n || (n = e.elements.popper.querySelector(n))) && H(e.elements.popper, n) && (e.elements.arrow = n)
            },
        ...
        function Z(t) {
            var e, i = t.popper, n = t.popperRect, l = t.placement, c = t.offsets, u = t.position, h = t.gpuAcceleration, d = t.adaptive, p = t.roundOffsets, f = !0 === p ? function(t) {
                var e = t.x
                  , i = t.y
            ...
            }(c) : "function" == typeof p ? p(c) : c, m = f.x, g = void 0 === m ? 0 : m, y = f.y, v = void 0 === y ? 0 : y, b = c.hasOwnProperty("x"), w = c.hasOwnProperty("y"), _ = a, E = s, x = window;
            if (d) {
                var k = q(i)
                  , T = "clientHeight"
                  , C = "clientWidth";
                k === L(i) && "static" !== F(k = R(i)).position && (T = "scrollHeight",
                C = "scrollWidth"),
                k = k,
                l === s && (E = o,
                v -= k[T] - n.height,
            ...
            return h ? Object.assign({}, A, ((S = {})[E] = w ? "0" : "",
            S[_] = b ? "0" : "",
            S.transform = (x.devicePixelRatio || 1) < 2 ? "translate(" + g + "px, " + v + "px)" : "translate3d(" + g + "px, " + v + "px, 0)",
            S)) : Object.assign({}, A, ((e = {})[E] = w ? v + "px" : "",
            e[_] = b ? g + "px" : "",
            e.transform = "",
            e))
        }
        const tt = {
            ...
            fn: function(t) {
                ...
                null != e.modifiersData.popperOffsets && (e.styles.popper = Object.assign({}, e.styles.popper, Z(Object.assign({}, c, {
                    offsets: e.modifiersData.popperOffsets,
                    position: e.options.strategy,
                    adaptive: r,
                    roundOffsets: l
                })))),
                null != e.modifiersData.arrow && (e.styles.arrow = Object.assign({}, e.styles.arrow, Z(Object.assign({}, c, {
        ...
        function ut(t) {
            return ["html", "body", "#document"].indexOf(A(t)) >= 0 ? t.ownerDocument.body : O(t) && ct(t) ? t : ut(B(t))
        }
        function ht(t, e) {
            var i;
            void 0 === e && (e = []);
        ...
        function pt(t, e) {
            return e === p ? dt(function(t) {
                ...
                var e, i = R(t), n = at(t), s = null == (e = t.ownerDocument) ? void 0 : e.body, o = V(i.scrollWidth, i.clientWidth, s ? s.scrollWidth : 0, s ? s.clientWidth : 0), r = V(i.scrollHeight, i.clientHeight, s ? s.scrollHeight : 0, s ? s.clientHeight : 0), a = -n.scrollLeft + lt(t), l = -n.scrollTop;
                return "rtl" === F(s || i).direction && (a += V(i.clientWidth, s ? s.clientWidth : 0) - o),
                {
                    width: o,
                    height: r,
                    x: a,
        ...
        function mt(t) {
            var e, i = t.reference, n = t.element, l = t.placement, c = l ? I(l) : null, d = l ? ft(l) : null, p = i.x + i.width / 2 - n.width / 2, f = i.y + i.height / 2 - n.height / 2;
            switch (c) {
            case s:
                e = {
                    x: p,
            ...
            var i = e
              ...
              , L = function(t, e, i) {
                var n = "clippingParents" === e ? function(t) {
                    var e = ht(B(t))
                      , i = ["absolute", "fixed"].indexOf(F(t).position) >= 0 && O(t) ? q(t) : t;
        ...
        const yt = {
            ...
            fn: function(t) {
                ...
                if (!e.modifiersData[n]._skip) {
                    for (var h = i.mainAxis, d = void 0 === h || h, p = i.altAxis, f = void 0 === p || p, m = i.fallbackPlacements, v = i.padding, b = i.boundary, w = i.rootBoundary, _ = i.altBoundary, E = i.flipVariations, x = void 0 === E || E, k = i.allowedAutoPlacements, T = e.options.placement, C = I(T), S = m || (C !== T && x ? function(t) {
                        if (I(t) === l)
                            return [];
                        var e = st(t);
                        return [rt(t), e, rt(e)]
                    }(T) : [st(T)]), A = [T].concat(S).reduce((function(t, i) {
                        return t.concat(I(i) === l ? function(t, e) {
                            void 0 === e && (e = {});
                            var i = e
                              , n = i.placement
                              , s = i.boundary
                    ...
                    ), []), L = e.rects.reference, P = e.rects.popper, O = new Map, M = !0, N = A[0], D = 0; D < A.length; D++) {
                        var j = A[D]
                          , H = I(j)
                          , F = ft(j) === u
                          , z = [s, o].indexOf(H) >= 0
                    ...
                    if (M)
                        for (var V = function(t) {
                            ...
                            if (e)
                                return N = e,
                                "break"
                        }, U = x ? 3 : 1; U > 0 && "break" !== V(U); U--)
                            ;
                    e.placement !== N && (e.modifiersData[n]._skip = !0,
                    e.placement = N,
                    e.reset = !0)
                }
            },
          ...
          , xt = {
            ...
            fn: function(t) {
                var e = t.state
                  ...
                  , A = e.rects.reference
                  , L = e.rects.popper
                  , P = "function" == typeof w ? w(Object.assign({}, e.rects, {
                    placement: e.placement
                })) : w
                  , O = {
                    x: 0,
                ...
                if (S) {
                    if (c || d) {
                        var M = "y" === T ? s : a
                          ...
                          , nt = it ? "y" === T ? it.clientTop || 0 : it.clientLeft || 0 : 0
                          , st = e.modifiersData.offset ? e.modifiersData.offset[e.placement][T] : 0
                          , ot = S[T] + tt - st - nt
                          , rt = S[T] + et - st;
                        if (c) {
        ...
        function kt(t, e, i) {
            ...
            return (a || !a && !i) && (("body" !== A(e) || ct(o)) && (l = (n = e) !== L(n) && O(n) ? {
                scrollLeft: (s = n).scrollLeft,
                scrollTop: s.scrollTop
            } : at(n)),
            O(e) ? ((c = D(e)).x += e.clientLeft,
            c.y += e.clientTop) : o && (c.x = lt(o))),
            {
            ...
            return function(t, e, i) {
                ...
                var s, r, a = {
                    ...
                    setOptions: function(i) {
                        ...
                        a.scrollParents = {
                            reference: P(t) ? ht(t) : t.contextElement ? ht(t.contextElement) : [],
                            popper: ht(e)
                        };
        ...
        const Mt = {
          ...
          , zt = t=>!(!t || "object" != typeof t) && (void 0 !== t.jquery && (t = t[0]),
        void 0 !== t.nodeType)
          , Rt = t=>zt(t) ? t.jquery ? t[0] : t : "string" == typeof t && t.length > 0 ? Mt.findOne(t) : null
          , Bt = (t,e,i)=>{
            Object.keys(i).forEach((n=>{
                const s = i[n]
                  , o = e[n]
                  , r = o && zt(o) ? "element" : null == (a = o) ? `${a}` : {}.toString.call(a).match(/\s([a-z]+)/i)[1].toLowerCase();
                var a;
          ...
          , $t = t=>!(!zt(t) || 0 === t.getClientRects().length) && "visible" === getComputedStyle(t).getPropertyValue("visibility")
        ...
        me.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', be.handleDismiss(new be)),
        Xt(be);
        ...
        class He extends ve {
            constructor(t, e) {
                ...
                this._indicatorsElement = Mt.findOne(".carousel-indicators", this._element),
            ...
            pause(t) {
                t || (this._isPaused = !0),
                Mt.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (Ft(this._element),
                this.cycle(!0)),
            ...
            _addTouchEventListeners() {
                const t = t=>{
                    !this._pointerEvent || "pen" !== t.pointerType && t.pointerType !== je ? this._pointerEvent || (this.touchStartX = t.touches[0].clientX) : this.touchStartX = t.clientX
                }
                  , e = t=>{
                    this.touchDeltaX = t.touches && t.touches.length > 1 ? 0 : t.touches[0].clientX - this.touchStartX
                }
                  , i = t=>{
                    !this._pointerEvent || "pen" !== t.pointerType && t.pointerType !== je || (this.touchDeltaX = t.clientX - this.touchStartX),
                    this._handleSwipe(),
                ...
                this._pointerEvent ? (me.on(this._element, "pointerdown.bs.carousel", (e=>t(e))),
                me.on(this._element, "pointerup.bs.carousel", (t=>i(t))),
                this._element.classList.add("pointer-event")) : (me.on(this._element, "touchstart.bs.carousel", (e=>t(e))),
            ...
            _getItemIndex(t) {
                return this._items = t && t.parentNode ? Mt.find(".carousel-item", t.parentNode) : [],
            ...
            _slide(t, e) {
                ...
                if (o && o.classList.contains(Ie))
                    return void (this._isSliding = !1);
                if (this._isSliding)
                    return;
                if (this._triggerSlideEvent(o, h).defaultPrevented)
                    return;
                if (!n || !o)
                    return;
                this._isSliding = !0,
            ...
            _directionToOrder(t) {
                return [Oe, Pe].includes(t) ? Kt() ? t === Pe ? Le : Ae : t === Pe ? Ae : Le : t
            }
            _orderToDirection(t) {
                return [Ae, Le].includes(t) ? Kt() ? t === Le ? Pe : Oe : t === Le ? Oe : Pe : t
            }
        ...
        me.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", He.dataApiClickHandler),
        ...
        class Ye extends ve {
            constructor(t, e) {
                ...
                this._config = this._getConfig(e),
                this._triggerArray = Mt.find(`${Ue}[href="#${this._element.id}"],${Ue}[data-bs-target="#${this._element.id}"]`);
                const i = Mt.find(Ue);
            ...
            show() {
                if (this._isTransitioning || this._element.classList.contains(Be))
                    return;
                let t, e;
                this._parent && (t = Mt.find(".show, .collapsing", this._parent).filter((t=>"string" == typeof this._config.parent ? t.getAttribute("data-bs-parent") === this._config.parent : t.classList.contains($e))),
                0 === t.length && (t = null));
                const i = Mt.findOne(this._selector);
                if (t) {
                    const n = t.find((t=>i !== t));
                    if (e = n ? Ye.getInstance(n) : null,
                ...
                if (e > 0)
                    for (let t = 0; t < e; t++) {
                        const e = this._triggerArray[t]
                          , i = Ht(e);
                        i && !i.classList.contains(Be) && (e.classList.add(We),
        ...
        class pi extends ve {
            ...
            toggle() {
                qt(this._element) || (this._element.classList.contains(ii) ? this.hide() : this.show())
            }
            show() {
                if (qt(this._element) || this._menu.classList.contains(ii))
                    return;
                const t = pi.getParentFromElement(this._element)
                  , e = {
                    relatedTarget: this._element
                };
                if (!me.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
                    if (this._inNavbar)
                        ...
                        let e = this._element;
                        "parent" === this._config.reference ? e = t : zt(this._config.reference) ? e = Rt(this._config.reference) : "object" == typeof this._config.reference && (e = this._config.reference);
                        const i = this._getPopperConfig()
                          , s = i.modifiers.find((t=>"applyStyles" === t.name && !1 === t.enabled));
                        this._popper = Pt(e, this._menu, i),
                        s && ke.setDataAttribute(this._menu, "popper", "static")
                    }
                    "ontouchstart"in document.documentElement && !t.closest(".navbar-nav") && [].concat(...document.body.children).forEach((t=>me.on(t, "mouseover", Vt))),
                    this._element.focus(),
            ...
            _completeHide(t) {
                me.trigger(this._element, "hide.bs.dropdown", t).defaultPrevented || ("ontouchstart"in document.documentElement && [].concat(...document.body.children).forEach((t=>me.off(t, "mouseover", Vt))),
                this._popper && this._popper.destroy(),
            ...
            _getConfig(t) {
                ...
                "object" == typeof t.reference && !zt(t.reference) && "function" != typeof t.reference.getBoundingClientRect)
            ...
            _selectMenuItem({key: t, target: e}) {
                const i = Mt.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", this._menu).filter($t);
            ...
            static clearMenus(t) {
                ...
                for (let i = 0, n = e.length; i < n; i++) {
                    ...
                    if (!n || !1 === n._config.autoClose)
                        continue;
                    if (!n._element.classList.contains(ii))
                        continue;
                    const s = {
            ...
            static dataApiKeydownHandler(t) {
                if (/input|textarea/i.test(t.target.tagName) ? t.key === Xe || t.key !== Ke && (t.key !== Je && t.key !== Ge || t.target.closest(si)) : !Ze.test(t.key))
                    return;
                ...
                return t.key === Ke ? (i().focus(),
                void pi.clearMenus()) : t.key === Ge || t.key === Je ? (e || i().click(),
                void pi.getInstance(i())._selectMenuItem(t)) : void (e && t.key !== Xe || pi.clearMenus())
            }
        }
        ...
        class gi {
            ...
            _resetElementAttributes(t, e) {
                this._applyManipulationCallback(t, (t=>{
                    ...
                    void 0 === i ? t.style.removeProperty(e) : (ke.removeDataAttribute(t, e),
                    t.style[e] = i)
                }
                ))
            }
        ...
        class _i {
            ...
            dispose() {
                this._isAppended && (me.off(this._element, wi),
        ...
        class ji extends ve {
            ...
            show(t) {
                this._isShown || this._isTransitioning || me.trigger(this._element, Si, {
                    relatedTarget: t
                ...
                me.on(this._element, Pi, '[data-bs-dismiss="modal"]', (t=>this.hide(t))),
            ...
            _setEscapeEvent() {
                this._isShown ? me.on(this._element, Oi, (t=>{
                    this._config.keyboard && t.key === xi ? (t.preventDefault(),
                    this.hide()) : this._config.keyboard || t.key !== xi || this._triggerBackdropTransition()
                }
                )) : me.off(this._element, Oi)
            }
            _setResizeEvent() {
                this._isShown ? me.on(window, Li, (()=>this._adjustDialog())) : me.off(window, Li)
            }
            _hideModal() {
            ...
            _triggerBackdropTransition() {
                ...
                !n && "hidden" === i.overflowY || t.contains(Di) || (n || (i.overflowY = "hidden"),
                t.add(Di),
                this._queueCallback((()=>{
                    t.remove(Di),
            ...
            _adjustDialog() {
                const t = this._element.scrollHeight > document.documentElement.clientHeight
                  ...
                  , i = e > 0;
                (!i && t && !Kt() || i && !t && Kt()) && (this._element.style.paddingLeft = `${e}px`),
                (i && !t && !Kt() || !i && t && Kt()) && (this._element.style.paddingRight = `${e}px`)
            }
            _resetAdjustments() {
        ...
        me.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', (function(t) {
            ...
            me.one(e, Si, (t=>{
                t.defaultPrevented || me.one(e, Ci, (()=>{
                    $t(this) && this.focus()
                }
                ))
            }
        ...
        class Wi extends ve {
            ...
            show(t) {
                this._isShown || me.trigger(this._element, "show.bs.offcanvas", {
                    relatedTarget: t
                }).defaultPrevented || (this._isShown = !0,
            ...
            hide() {
                this._isShown && (me.trigger(this._element, "hide.bs.offcanvas").defaultPrevented || (me.off(document, qi),
                this._element.blur(),
                this._isShown = !1,
            ...
            _addEventListeners() {
                me.on(this._element, "click.dismiss.bs.offcanvas", '[data-bs-dismiss="offcanvas"]', (()=>this.hide())),
        ...
        me.on(window, "load.bs.offcanvas.data-api", (()=>Mt.find(Bi).forEach((t=>Wi.getOrCreateInstance(t).show())))),
        Xt(Wi);
        const Vi = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"])
          ...
          , Qi = (t,e)=>{
            ...
            if (e.includes(i))
                return !Vi.has(i) || Boolean(Ui.test(t.nodeValue) || Yi.test(t.nodeValue));
        ...
        class un extends ve {
            ...
            dispose() {
                ...
                me.off(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler),
            ...
            show() {
                ...
                this._popper ? this._popper.update() : this._popper = Pt(this._element, n, this._getPopperConfig(r)),
                n.classList.add(on);
            ...
            hide() {
                ...
                "ontouchstart"in document.documentElement && [].concat(...document.body.children).forEach((t=>me.off(t, "mouseover", Vt))),
                this._activeTrigger.click = !1,
                this._activeTrigger.focus = !1,
                this._activeTrigger.hover = !1;
                const e = this.tip.classList.contains(sn);
                this._queueCallback((()=>{
                    this._isWithActiveTrigger() || (this._hoverState !== rn && t.remove(),
                    this._cleanTipClass(),
            ...
            setContent() {
                const t = this.getTipElement();
                this.setElementContent(Mt.findOne(".tooltip-inner", t), this.getTitle()),
            ...
            setElementContent(t, e) {
                if (null !== t)
                    ...
                    t.appendChild(e)) : t.textContent = e.textContent)) : void (this._config.html ? (this._config.sanitize && (e = Ki(e, this._config.allowList, this._config.sanitizeFn)),
            ...
            _initializeOnDelegatedTarget(t, e) {
                ...
                return (e = e || ye.get(t.delegateTarget, i)) || (e = new this.constructor(t.delegateTarget,this._getDelegateConfig()),
            ...
            _setListeners() {
                this._config.trigger.split(" ").forEach((t=>{
                    if ("click" === t)
                        ...
                        const e = t === ln ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN
                          , i = t === ln ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT;
                ...
                ,
                me.on(this._element.closest(".modal"), "hide.bs.modal", this._hideModalHandler),
            ...
            _enter(t, e) {
                ...
                e.getTipElement().classList.contains(on) || e._hoverState === rn ? e._hoverState = rn : (clearTimeout(e._timeout),
                e._hoverState = rn,
            ...
            _leave(t, e) {
                e = this._initializeOnDelegatedTarget(t, e),
                t && (e._activeTrigger["focusout" === t.type ? cn : ln] = e._element.contains(t.relatedTarget)),
            ...
            _getConfig(t) {
                ...
                (t = {
                    ...
                    ...e,
                    ..."object" == typeof t && t ? t : {}
                }).container = !1 === t.container ? document.body : Rt(t.container),
                ...
                t.sanitize && (t.template = Ki(t.template, t.allowList, t.sanitizeFn)),
                t
            }
            _getDelegateConfig() {
                const t = {};
        ...
        class xn extends ve {
            ...
            refresh() {
                ...
                Mt.find(this._selector).map((t=>{
                    const n = jt(t)
                      , s = n ? Mt.findOne(n) : null;
                    if (s) {
                        const t = s.getBoundingClientRect();
                        if (t.width || t.height)
                            return [ke[e](s).top + i, n]
                    }
                    return null
                }
            ...
            dispose() {
                me.off(this._scrollElement, ".bs.scrollspy"),
                super.dispose()
            }
            _getConfig(t) {
                if ("string" != typeof (t = {
            ...
            _activate(t) {
                ...
                const e = this._selector.split(",").map((e=>`${e}[data-bs-target="${t}"],${e}[href="${t}"]`))
                  , i = Mt.findOne(e.join(","));
                i.classList.contains("dropdown-item") ? (Mt.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add(_n),
                i.classList.add(_n)) : (i.classList.add(_n),
                Mt.parents(i, ".nav, .list-group").forEach((t=>{
                    Mt.prev(t, ".nav-link, .list-group-item").forEach((t=>t.classList.add(_n))),
                    Mt.prev(t, ".nav-item").forEach((t=>{
                        Mt.children(t, ".nav-link").forEach((t=>t.classList.add(_n)))
                    }
                    ))
                }
                ))),
            ...
            _clear() {
                Mt.find(this._selector).filter((t=>t.classList.contains(_n))).forEach((t=>t.classList.remove(_n)))
            }
            static jQueryInterface(t) {
                return this.each((function() {
        ...
        class Ln extends ve {
            ...
            show() {
                if (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains(kn))
                    return;
                let t;
            ...
            _activate(t, e, i) {
                const n = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? Mt.children(e, Sn) : Mt.find(An, e))[0]
            ...
            _transitionComplete(t, e, i) {
                ...
                n && n.classList.contains("dropdown-menu")) {
                    ...
                    e && Mt.find(".dropdown-toggle", e).forEach((t=>t.classList.add(kn))),
                    t.setAttribute("aria-expanded", !0)
                }
                i && i()
            }
        ...
        class jn extends ve {
            ...
            show() {
                me.trigger(this._element, "show.bs.toast").defaultPrevented || (this._clearTimeout(),
            ...
            hide() {
                this._element.classList.contains(Mn) && (me.trigger(this._element, "hide.bs.toast").defaultPrevented || (this._element.classList.remove(Mn),
                this._queueCallback((()=>{
            ...
            dispose() {
                this._clearTimeout(),
                this._element.classList.contains(Mn) && this._element.classList.remove(Mn),
                super.dispose()
            }
            _getConfig(t) {
                return t = {
            ...
            _setListeners() {
                me.on(this._element, "click.dismiss.bs.toast", '[data-bs-dismiss="toast"]', (()=>this.hide())),
    ...
    631: function(t) {
        t.exports = function() {
            ...
            function i(t, i, n) {
                ...
                return t.addEventListener("scroll", h, d),
                u(),
                {
                    destroy: function() {
                        cancelAnimationFrame(s),
                        t.removeEventListener("scroll", h, d)
                    }
                }
            }
            function n(t) {
    ...
    391: (t,e,i)=>{
        var n, s;
        !function(o, r) {
            n = [i(794), i(131), i(741), i(47), i(568), i(835), i(666), i(947), i(157)],
            void 0 === (s = function(t, e, i, n, s, r) {
        ...
        !function(t) {
            ...
            function y(t, e, i, n) {
                ...
                var s = m(n, t)
                  , o = t[s - 1]
                  , r = t[s];
                return i ? n - o > (r - o) / 2 ? r : o : e[s - 1] ? t[s - 1] + function(t, e) {
            ...
            var w = function() {
                ...
                t.prototype.getAbsoluteDistance = function(t, e, i) {
                    ...
                    if (t < this.xPct[this.xPct.length - 1])
                        ...
                        t === this.xPct[this.xPct.length - 1] && (s = this.xPct.length - 2);
                    i || t !== this.xPct[s + 1] || s++,
                    null === e && (e = []);
                    var o = 1
                      , r = e[s]
                      ...
                      , c = 0
                      , u = 0;
                    for (n = i ? (t - this.xPct[s]) / (this.xPct[s + 1] - this.xPct[s]) : (this.xPct[s + 1] - t) / (this.xPct[s + 1] - this.xPct[s]); r > 0; )
                        a = this.xPct[s + 1 + u] - this.xPct[s + u],
                        e[s + u] * o + 100 - 100 * n > 100 ? (l = a * n,
                        o = (r - 100 * n) / e[s + u],
                        n = 1) : (l = e[s + u] * a / 100 * o,
                        o = 0),
                        i ? (c -= l,
                ...
                t.prototype.handleEntryPoint = function(t, e) {
                    var i;
                    if (!o(i = "min" === t ? 0 : "max" === t ? 100 : parseFloat(t)) || !o(e[0]))
            ...
            function Y(t) {
                ...
                e.transformRule = a ? "transform" : r ? "msTransform" : "webkitTransform";
                return e.style = [["left", "top"], ["right", "bottom"]][e.dir][e.ort],
                e
            }
            function Q(e, o, c) {
                var p, f, m, g, y, v, b, w = window.navigator.pointerEnabled ? {
                    start: "pointerdown",
                    move: "pointermove",
                    end: "pointerup"
                    ...
                    return t
                }(), E = e, T = o.spectrum, C = [], S = [], A = [], L = 0, P = {}, O = e.ownerDocument, M = o.documentElement || O.documentElement, N = O.body, I = "rtl" === O.dir || 1 === o.ort ? 0 : 100;
                function D(t, e) {
                ...
                function j(t, e) {
                    ...
                    return D(n, o.cssClasses.touchArea),
                    ...
                    n.addEventListener("keydown", (function(t) {
                        return function(t, e) {
                            ...
                            s.reverse());
                            var a, l = t.key.replace("Arrow", ""), c = l === s[0], u = l === s[1], h = l === n[0] || l === i[0] || c, d = l === n[1] || l === i[1] || u, p = l === r[0], f = l === r[1];
                            if (!(h || d || p || f))
                                return !0;
                            if (t.preventDefault(),
                            d || h) {
                                ...
                                if (null === y)
                                    return !1;
                                !1 === y && (y = T.getDefaultStep(S[e], h, o.keyboardDefaultStep)),
                                (u || c) && (y *= m),
                                y = Math.max(y, 1e-7),
                                y *= h ? -1 : 1,
                                a = C[e] + y
                            } else
                                a = f ? o.spectrum.xVal[o.spectrum.xVal.length - 1] : o.spectrum.xVal[0];
                            return dt(e, T.toStepping(a), !0, !0),
                            rt("slide", e),
                            rt("update", e),
                            rt("change", e),
                            rt("set", e),
                    ...
                    0 === e ? u(n, o.cssClasses.handleLower) : e === o.handles - 1 && u(n, o.cssClasses.handleUpper),
                    i
                }
                function H(t, e) {
                ...
                function F(t, e) {
                    return !(!o.tooltips || !o.tooltips[e]) && D(t.firstChild, o.cssClasses.tooltip)
                }
                function z() {
                ...
                function W(e) {
                    ...
                    }(e), s = {}, o = T.xVal[0], r = T.xVal[T.xVal.length - 1], a = !1, l = !1, c = 0;
                    ...
                    n.forEach((function(i, o) {
                        var r, u, h, d, p, f, m, g, y, v, b = i, w = n[o + 1], _ = e.mode === t.PipsMode.Steps;
                        for (_ && (r = T.xNumSteps[o]),
                        r || (r = w - b),
                        void 0 === w && (w = b),
                        r = Math.max(r, 1e-7),
                        u = b; u <= w; u = Number((u + r).toFixed(7))) {
                            for (g = (p = (d = T.toStepping(u)) - c) / (e.density || 1),
                            v = p / (y = Math.round(g)),
                            h = 1; h <= y; h += 1)
                                s[(f = c + h * v).toFixed(5)] = [T.fromStepping(f), 0];
                            m = n.indexOf(u) > -1 ? t.PipsType.LargeValue : _ ? t.PipsType.SmallValue : t.PipsType.NoValue,
                            !o && a && u !== w && (m = 0),
                ...
                function V(e, i, n) {
                    var s, r, a = O.createElement("div"), l = ((s = {})[t.PipsType.None] = "",
                    ...
                    r), h = [o.cssClasses.valueHorizontal, o.cssClasses.valueVertical], d = [o.cssClasses.markerHorizontal, o.cssClasses.markerVertical];
                    function p(t, e) {
                        var i = e === o.cssClasses.value
                          , n = i ? l : c;
                        return e + " " + (i ? h : d)[o.ort] + " " + n[t]
                    }
                    return u(a, o.cssClasses.pips),
                    u(a, 0 === o.ort ? o.cssClasses.pipsHorizontal : o.cssClasses.pipsVertical),
                    Object.keys(e).forEach((function(s) {
                        !function(e, s, r) {
                            if ((r = i ? i(s, r) : r) !== t.PipsType.None) {
                                ...
                                l.style[o.style] = e + "%",
                                r > t.PipsType.NoValue && ((l = D(a, !1)).className = p(r, o.cssClasses.value),
                ...
                function X(t, e, i, n) {
                    var s = function(s) {
                        ...
                        return !!l && !(z() && !n.doNotReject) && (r = E,
                        a = o.cssClasses.tap,
                        !((r.classList ? r.classList.contains(a) : new RegExp("\\b" + a + "\\b").test(r.className)) && !n.doNotReject)) && !(t === w.start && void 0 !== l.buttons && l.buttons > 1) && (!n.hover || !l.buttons) && (_ || l.preventDefault(),
                        l.calcPoint = l.points[o.ort],
                        void i(l, n))
                    }
                      , r = [];
                    return t.split(" ").forEach((function(t) {
                        e.addEventListener(t, s, !!_ && {
                            passive: !0
                        }),
                        r.push([t, s])
                    }
                ...
                function G(t) {
                    ...
                    i ? n.top + l.y - r.clientTop : n.left + l.x - r.clientLeft)) / K();
                    return c = a(c),
                    o.dir ? 100 - c : c
                }
                function J(t, e) {
                ...
                function Z(t, e) {
                    ...
                    ct(i > 0, 100 * i / e.baseSize, e.locations, e.handleNumbers, e.connect)
                }
                function tt(t, e) {
                    e.handle && (h(e.handle, o.cssClasses.active),
                    L -= 1),
                    e.listeners.forEach((function(t) {
                        M.removeEventListener(t[0], t[1])
                    }
                    )),
                    0 === L && (h(E, o.cssClasses.drag),
                    ht(),
                    t.cursor && (N.style.cursor = "",
                ...
                function et(t, e) {
                    if (!e.handleNumbers.some(R)) {
                        var i;
                        1 === e.handleNumbers.length && (i = f[e.handleNumbers[0]].children[0],
                        L += 1,
                        ...
                        t.cursor && (N.style.cursor = getComputedStyle(t.target).cursor,
                ...
                function it(t) {
                    ...
                    !1 !== i && (o.events.snap || r(E, o.cssClasses.tap, o.animationDuration),
                    dt(i, e, !0, !0),
                    ht(),
                    rt("slide", i, !0),
                    rt("update", i, !0),
                ...
                function nt(t) {
                    ...
                    Object.keys(P).forEach((function(t) {
                        "hover" === t.split(".")[0] && P[t].forEach((function(t) {
                            t.call(vt, n)
                        }
                        ))
                    }
                ...
                function rt(t, e, i) {
                    Object.keys(P).forEach((function(n) {
                        var s = n.split(".")[0];
                        t === s && P[n].forEach((function(t) {
                            t.call(vt, C.map(o.format.to), e, C.slice(), i || !1, S.slice(), vt)
                        }
                        ))
                    }
                    ))
                ...
                function at(t, e, i, n, s, r) {
                    var l;
                    return f.length > 1 && !o.events.unconstrained && (n && e > 0 && (l = T.getAbsoluteDistance(t[e - 1], o.margin, !1),
                    i = Math.max(i, l)),
                    s && e < f.length - 1 && (l = T.getAbsoluteDistance(t[e + 1], o.margin, !0),
                    i = Math.min(i, l))),
                    f.length > 1 && o.limit && (n && e > 0 && (l = T.getAbsoluteDistance(t[e - 1], o.limit, !1),
                    i = Math.min(i, l)),
                    s && e < f.length - 1 && (l = T.getAbsoluteDistance(t[e + 1], o.limit, !0),
                    i = Math.max(i, l))),
                    o.padding && (0 === e && (l = T.getAbsoluteDistance(0, o.padding[0], !1),
                    i = Math.max(i, l)),
                    e === f.length - 1 && (l = T.getAbsoluteDistance(100, o.padding[1], !0),
                    i = Math.min(i, l))),
                ...
                function dt(t, e, i, n, s) {
                    return s || (e = at(S, t, e, i, n, !1)),
                    !1 !== e && (function(t, e) {
                        S[t] = e,
                        C[t] = T.fromStepping(e);
                        var i = "translate(" + lt(10 * (ut(e, 0) - I) + "%", "0") + ")";
                        f[t].style[o.transformRule] = i,
                        pt(t),
                        pt(t + 1)
                    }(t, e),
                    !0)
                ...
                function yt(t) {
                    ...
                    r = n > i.thisStep.startValue ? i.thisStep.step : !1 !== i.stepBefore.step && n - i.stepBefore.highestStep,
                    100 === e ? s = null : 0 === e && (r = null);
                    var a = T.countStepDecimals();
                    return null !== s && !1 !== s && (s = Number(s.toFixed(a))),
                    null !== r && !1 !== r && (r = Number(r.toFixed(a))),
                    [r, s]
                }
                u(b = E, o.cssClasses.target),
                0 === o.dir ? u(b, o.cssClasses.ltr) : u(b, o.cssClasses.rtl),
                0 === o.ort ? u(b, o.cssClasses.horizontal) : u(b, o.cssClasses.vertical),
                u(b, "rtl" === getComputedStyle(b).direction ? o.cssClasses.textDirectionRtl : o.cssClasses.textDirectionLtr),
                ...
                (v = o.events).fixed || f.forEach((function(t, e) {
                ...
                v.hover && X(w.move, p, nt, {
                    hover: !0
                }),
                v.drag && m.forEach((function(t, e) {
                    if (!1 !== t && 0 !== e && e !== m.length - 1) {
                        var i = f[e - 1]
                          , n = f[e]
                          , s = [t];
                        u(t, o.cssClasses.draggable),
                        v.fixed && (s.push(i.children[0]),
                        s.push(n.children[0])),
        ...
        "object" == typeof navigator && (t.exports = function() {
            ...
            var b = function() {
                function t(e, i) {
                    ...
                    g(e) ? this.element = e : p(e) && (this.element = document.querySelector(e)),
                    g(this.element) && v(this.element.rangeTouch) && (this.config = o({}, r, {}, i),
                    this.init())
                }
                return function(t, i, n) {
                    ...
                    value: function(e) {
                        if (!t.enabled || !y(e))
                            return null;
                        var i, n = e.target, s = e.changedTouches[0], o = parseFloat(n.getAttribute("min")) || 0, r = parseFloat(n.getAttribute("max")) || 100, a = parseFloat(n.getAttribute("step")) || 1, l = n.getBoundingClientRect(), c = 100 / l.width * (this.config.thumbWidth / 2) / 100;
                    ...
                    value: function(e) {
                        var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}
                          , n = null;
                        if (v(e) || p(e) ? n = Array.from(document.querySelectorAll(p(e) ? e : 'input[type="range"]')) : g(e) ? n = [e] : m(e) ? n = Array.from(e) : f(e) && (n = e.filter(g)),
                        v(n))
                            return null;
                        var s = o({}, r, {}, i);
                        return p(e) && s.watch && new MutationObserver((function(i) {
            ...
            const w = t=>null != t ? t.constructor : null
              ...
              , C = t=>Array.isArray(t)
              , S = t=>_(t, NodeList)
              , A = t=>E(t) || (k(t) || C(t) || S(t)) && !t.length || x(t) && !Object.keys(t).length;
            var L = E
              , P = x
              ...
              , D = C
              , j = S
              , H = t=>null !== t && "object" == typeof t && 1 === t.nodeType && "object" == typeof t.style && "object" == typeof t.ownerDocument
              , F = t=>_(t, Event)
            ...
            function Y(t={}, ...e) {
                if (!e.length)
                    return t;
                const i = e.shift();
                return P(i) ? (Object.keys(i).forEach((e=>{
                    P(i[e]) ? (Object.keys(t).includes(e) || Object.assign(t, {
                        [e]: {}
                    }),
            ...
            function K(t, e) {
                H(t) && !$(e) && Object.entries(e).filter((([,t])=>!L(t))).forEach((([e,i])=>t.setAttribute(e, i)))
            }
            function X(t, e, i) {
            ...
            function J(t) {
                j(t) || D(t) ? Array.from(t).forEach(J) : H(t) && H(t.parentNode) && t.parentNode.removeChild(t)
            }
            function Z(t) {
                if (!H(t))
                    return;
            ...
            function tt(t, e) {
                return H(e) && H(e.parentNode) && H(t) ? (e.parentNode.replaceChild(t, e),
                t) : null
            }
            function et(t, e) {
                if (!M(t) || $(t))
            ...
            function nt(t, e, i) {
                if (j(t))
                    return Array.from(t).map((t=>nt(t, e, i)));
                if (H(t)) {
                    let n = "toggle";
            ...
            const ct = {
              ...
              , ut = {
                ...
                pip: !(V.isIPhone || !I(X("video").webkitSetPresentationMode) && (!document.pictureInPictureEnabled || X("video").disablePictureInPicture)),
            ...
            function dt(t, e, i, n=!1, s=!0, o=!1) {
                if (!t || !("addEventListener"in t) || $(e) || !I(i))
                    return;
                const r = e.split(" ");
                let a = o;
                ht && (a = {
            ...
            function _t(t, e) {
                return D(t) && t.length ? t.reduce(((t,i)=>Math.abs(i - e) < Math.abs(t - e) ? i : t)) : null
            }
            function Et(t) {
            ...
            function kt(t) {
                return !!(D(t) || M(t) && t.includes(":")) && (D(t) ? t : t.split(":")).map(Number).every(O)
            }
            function Tt(t) {
                if (!D(t) || !t.every(O))
                    return null;
            ...
            function Ct(t) {
                ...
                null === i && !$(this.embed) && D(this.embed.ratio) && ({ratio: i} = this.embed),
                null === i && this.isHTML5) {
            ...
            function St(t) {
                ...
                const [n,s] = Tt(i)
                  , o = 100 / n * s;
                if (Et(`aspect-ratio: ${n}/${s}`) ? e.style.aspectRatio = `${n}/${s}` : e.style.paddingBottom = `${o}%`,
            ...
            const Lt = {
                ...
                getQualityOptions() {
                    return this.config.quality.forced ? this.config.quality.options : Lt.getSources.call(this).map((t=>Number(t.getAttribute("size")))).filter(Boolean)
                },
                setup() {
                    if (!this.isHTML5)
                        return;
                    ...
                    Object.defineProperty(t.media, "quality", {
                        get() {
                            const e = Lt.getSources.call(t).find((e=>e.getAttribute("src") === t.source));
                            return e && Number(e.getAttribute("size"))
                        },
                        set(e) {
                            if (t.quality !== e) {
                                if (t.config.quality.forced && I(t.config.quality.onChange))
                                    t.config.quality.onChange(e);
                                else {
                                    const i = Lt.getSources.call(t).find((t=>Number(t.getAttribute("size")) === e));
                                    if (!i)
                                        return;
                                    const {currentTime: n, paused: s, preload: o, readyState: r, playbackRate: a} = t.media;
                                    t.media.src = i.getAttribute("src"),
                                    ("none" !== o || r) && (t.once("loadedmetadata", (()=>{
                                        t.speed = a,
                                        t.currentTime = n,
                                        s || bt(t.play())
                                    }
                ...
                cancelRequests() {
                    this.isHTML5 && (J(Lt.getSources.call(this)),
            ...
            function Pt(t, ...e) {
                return $(t) ? t : t.toString().replace(/{(\d+)}/g, ((t,i)=>e[i].toString()))
            }
            const Ot = (t="",e="",i="")=>t.replace(new RegExp(e.toString().replace(/([.*+?^=!:${}()|[\]/\\])/g, "\\$1"),"g"), i.toString())
            ...
            const It = {
              ...
              , Dt = {
                get(t="", e={}) {
                    ...
                    let i = U(e.i18n, t);
                    if ($(i))
                        return Object.keys(It).includes(t) ? It[t] : "";
                    const n = {
                        "{seektime}": e.seekTime,
                        "{title}": e.title
                    };
            ...
            function Ft(t, e) {
                ...
                if (!i || !s()) {
                    ...
                    Ht(t).then((t=>{
                        $(t) || (s && window.localStorage.setItem(`cache-${e}`, JSON.stringify({
                            content: t
                        })),
                        o(r, t))
                    }
            ...
            const Bt = {
                getIconUrl() {
                    const t = new URL(this.config.iconUrl,window.location).host !== window.location.host || V.isIE && !window.svg4everybody;
                    return {
                ...
                findElements() {
                    try {
                        return this.elements.controls = at.call(this, this.config.selectors.controls.wrapper),
                        ...
                        this.elements.progress = at.call(this, this.config.selectors.progress),
                ...
                createButton(t, e) {
                    ...
                    switch (["element", "icon", "label"].forEach((t=>{
                        Object.keys(i).includes(t) && (s[t] = i[t],
                        delete i[t])
                    }
                    )),
                    "button" !== s.element || Object.keys(i).includes("type") || (i.type = "button"),
                    Object.keys(i).includes("class") ? i.class.split(" ").some((t=>t === this.config.classNames.control)) || Y(i, {
                    ...
                    const o = X(s.element);
                    return s.toggle ? (o.appendChild(Bt.createIcon.call(this, s.iconPressed, {
                        class: "icon--pressed"
                    })),
                    o.appendChild(Bt.createIcon.call(this, s.icon, {
                        class: "icon--not-pressed"
                    })),
                    o.appendChild(Bt.createLabel.call(this, s.labelPressed, {
                        class: "label--pressed"
                    })),
                    ...
                    K(o, i),
                    "play" === n ? (D(this.elements.buttons[n]) || (this.elements.buttons[n] = []),
                    this.elements.buttons[n].push(o)) : this.elements.buttons[n] = o,
                    o
                },
                createRange(t, e) {
                    const i = X("input", Y(et(this.config.selectors.inputs[t]), {
                        type: "range",
                        min: 0,
                        max: 100,
                        step: .01,
                ...
                bindMenuItemShortcuts(t, e) {
                    pt.call(this, t, "keydown keyup", (i=>{
                        ...
                        if (!n && [32, 39].includes(i.which))
                            ...
                            let e;
                            32 !== i.which && (40 === i.which || n && 39 === i.which ? (e = t.nextElementSibling,
                            H(e) || (e = t.parentNode.firstElementChild)) : (e = t.previousElementSibling,
                ...
                createMenuItem({value: t, list: e, type: i, title: n, badge: s=null, checked: o=!1}) {
                    ...
                    Object.defineProperty(a, "checked", {
                        ...
                        set(t) {
                            t && Array.from(a.parentNode.children).filter((t=>ot(t, '[role="menuitemradio"]'))).forEach((t=>t.setAttribute("aria-checked", "false"))),
                ...
                updateVolume() {
                    this.supported.ui && (H(this.elements.inputs.volume) && Bt.setRange.call(this, this.elements.inputs.volume, this.muted ? 0 : this.volume),
                    H(this.elements.buttons.mute) && (this.elements.buttons.mute.pressed = this.muted || 0 === this.volume))
                },
                setRange(t, e=0) {
                    H(t) && (t.value = e,
                    Bt.updateRangeFill.call(this, t))
                },
                updateProgress(t) {
                    ...
                    if (t)
                        ...
                        case "seeked":
                            n = this.currentTime,
                            s = this.duration,
                            e = 0 === n || 0 === s || Number.isNaN(n) || Number.isNaN(s) ? 0 : (n / s * 100).toFixed(2),
                            "timeupdate" === t.type && Bt.setRange.call(this, this.elements.inputs.seek, e);
                            break;
                        case "playing":
                        case "progress":
                ...
                updateSeekTooltip(t) {
                    ...
                    if (F(t))
                        ...
                        if (!st(this.elements.display.seekTooltip, e))
                            return;
                        n = parseFloat(this.elements.display.seekTooltip.style.left, 10)
                    }
                    n < 0 ? n = 0 : n > 100 && (n = 100),
                    Bt.updateTimeDisplay.call(this, this.elements.display.seekTooltip, this.duration / 100 * n),
                    this.elements.display.seekTooltip.style.left = `${n}%`,
                    F(t) && ["mouseenter", "mouseleave"].includes(t.type) && i("mouseenter" === t.type)
                },
                timeUpdate(t) {
                    const e = !H(this.elements.display.duration) && this.config.invertTime;
                    Bt.updateTimeDisplay.call(this, this.elements.display.currentTime, e ? this.duration - this.currentTime : this.currentTime, e),
                    t && "timeupdate" === t.type && this.media.seeking || Bt.updateProgress.call(this, t)
                },
                durationUpdate() {
                    ...
                    !t && this.config.displayDuration && this.paused && Bt.updateTimeDisplay.call(this, this.elements.display.currentTime, this.duration),
                    t && Bt.updateTimeDisplay.call(this, this.elements.display.duration, this.duration),
                ...
                updateSetting(t, e, i) {
                    ...
                    if ("captions" === t)
                        ...
                        !$(this.options[t]) && !this.options[t].includes(s))
                            return void this.debug.warn(`Unsupported value of '${s}' for ${t}`);
                        if (!this.config[t].options.includes(s))
                            return void this.debug.warn(`Disabled value of '${s}' for ${t}`)
                    }
                    if (H(o) || (o = n && n.querySelector('[role="menu"]')),
                    !H(o))
                        return;
                    this.elements.settings.buttons[t].querySelector(`.${this.config.classNames.menu.value}`).innerHTML = Bt.getLabel.call(this, t, s);
                ...
                getLabel(t, e) {
                    switch (t) {
                    case "speed":
                        return 1 === e ? Dt.get("normal", this.config) : `${e}&times;`;
                    case "quality":
                        if (O(e)) {
                ...
                setQualityMenu(t) {
                    ...
                    const n = !$(this.options.quality) && this.options.quality.length > 1;
                    if (Bt.toggleMenuButton.call(this, e, n),
                    Z(i),
                ...
                setCaptionsMenu() {
                    ...
                    const t = "captions"
                      ...
                      , n = Boolean(i.length);
                    if (Bt.toggleMenuButton.call(this, t, n),
                    Z(e),
                    Bt.checkMenu.call(this),
                    !n)
                        return;
                ...
                focusFirstMenuItem(t, e=!1) {
                    if (this.elements.settings.popup.hidden)
                        return;
                    let i = t;
                    H(i) || (i = Object.values(this.elements.settings.panels).find((t=>!t.hidden)));
                ...
                toggleMenu(t) {
                    ...
                    it(e, !s),
                    nt(this.elements.container, this.config.classNames.menu.open, s),
                    s && z(t) ? Bt.focusFirstMenuItem.call(this, null, !0) : s || n || lt.call(this, i, z(t))
                },
                getMenuSize(t) {
                ...
                showMenuPanel(t="", e=!1) {
                    ...
                    it(s, !0),
                    it(i, !1),
                    Bt.focusFirstMenuItem.call(this, i, e)
                },
                setDownloadUrl() {
                ...
                create(t) {
                    const {bindMenuItemShortcuts: e, createButton: i, createProgress: n, createRange: s, createTime: o, setQualityMenu: r, setSpeedMenu: a, showMenuPanel: l} = Bt;
                    ...
                    return wt(D(this.config.controls) ? this.config.controls : []).forEach((r=>{
                        ...
                        if ("current-time" === r && c.appendChild(o.call(this, "currentTime", u)),
                        "duration" === r && c.appendChild(o.call(this, "duration", u)),
                        "mute" === r || "volume" === r) {
                            let {volume: e} = this.elements;
                            if (H(e) && c.contains(e) || (e = X("div", Y({}, u, {
                            ...
                            "volume" === r && !V.isIos) {
                                ...
                                e.appendChild(s.call(this, "volume", Y(i, {
                                    id: `plyr-volume-${t.id}`
                                })))
                            }
                        }
                        ...
                        "settings" === r && !$(this.config.settings)) {
                            ...
                            this.config.settings.forEach((i=>{
                                const n = X("button", Y(et(this.config.selectors.buttons.settings), {
                                    type: "button",
                        ...
                        if ("pip" === r && ut.pip && c.appendChild(i.call(this, "pip", u)),
                        "airplay" === r && ut.airplay && c.appendChild(i.call(this, "airplay", u)),
                        "download" === r) {
                            const t = Y({}, u, {
                                element: "a",
                                href: this.download,
                ...
                inject() {
                    ...
                    let i, n = !0;
                    if (I(this.config.controls) && (this.config.controls = this.config.controls.call(this, e)),
                    this.config.controls || (this.config.controls = []),
                    H(this.config.controls) || M(this.config.controls) ? t = this.config.controls : (t = Bt.create.call(this, {
                        id: this.id,
                        seektime: this.config.seekTime,
                        speed: this.speed,
                    ...
                    i[H(t) ? "insertAdjacentElement" : "insertAdjacentHTML"]("afterbegin", t),
                    ...
                    !$(this.elements.buttons)) {
                        ...
                        Object.values(this.elements.buttons).filter(Boolean).forEach((e=>{
                            D(e) || j(e) ? Array.from(e).filter(Boolean).forEach(t) : t(e)
                        }
                        ))
                    }
                    if (V.isEdge && W(i),
            ...
            function qt(t) {
                ...
                return P(t) && Object.entries(t).forEach((([t,i])=>{
                    e.set(t, i)
                }
                )),
                e
            ...
            const Wt = {
                setup() {
                    if (!this.supported.ui)
                        return;
                    if (!this.isVideo || this.isYouTube || this.isHTML5 && !ut.textTracks)
                        return void (D(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && Bt.setCaptionsMenu.call(this));
                    var t, e;
                    if (H(this.elements.captions) || (this.elements.captions = X("div", et(this.config.selectors.captions)),
                    t = this.elements.captions,
                    e = this.elements.wrapper,
                    H(t) && H(e) && e.parentNode.insertBefore(t, e.nextSibling)),
                    V.isIE && window.URL) {
                        const t = this.media.querySelectorAll("track");
                        Array.from(t).forEach((t=>{
                            const e = t.getAttribute("src")
                              , i = $t(e);
                            null !== i && i.hostname !== window.location.href.hostname && ["http:", "https:"].includes(i.protocol) && Ht(e, "blob").then((e=>{
                    ...
                    if (N(s) || ({active: s} = this.config.captions),
                ...
                update() {
                    const t = Wt.getTracks.call(this, !0)
                      , {active: e, language: i, meta: n, currentTrackNode: s} = this.captions
                    ...
                    this.isHTML5 && this.isVideo && t.filter((t=>!n.get(t))).forEach((t=>{
                        ...
                        pt.call(this, t, "cuechange", (()=>Wt.updateCues.call(this)))
                    }
                    )),
                    (o && this.language !== i || !t.includes(s)) && (Wt.setLanguage.call(this, i),
                    Wt.toggle.call(this, e && o)),
                    nt(this.elements.container, this.config.classNames.captions.enabled, !$(t)),
                    D(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && Bt.setCaptionsMenu.call(this)
                },
                toggle(t, e=!0) {
                    if (!this.supported.ui)
                        return;
                    ...
                    if (s !== i) {
                        ...
                        gt.call(this, this.media, s ? "captionsenabled" : "captionsdisabled")
                    }
                    setTimeout((()=>{
                ...
                findTrack(t, e=!1) {
                    ...
                    let o;
                    return t.every((t=>(o = s.find((e=>e.language === t)),
                    !o))),
                    o || (e ? s[0] : void 0)
                },
                getCurrentTrack() {
                ...
                getLabel(t) {
                    let e = t;
                    return !R(e) && ut.textTracks && this.captions.toggled && (e = Wt.getCurrentTrack.call(this)),
                    R(e) ? $(e.label) ? $(e.language) ? Dt.get("enabled", this.config) : t.language.toUpperCase() : e.label : Dt.get("disabled", this.config)
                },
                updateCues(t) {
                    if (!this.supported.ui)
                        return;
                    ...
                    if (!e) {
                        ...
                        e = Array.from((t || {}).activeCues || []).map((t=>t.getCueAsHTML())).map(Nt)
                    }
            ...
            class Xt {
                ...
                get log() {
                    return this.enabled ? Function.prototype.bind.call(console.log, console) : Kt
                }
                get warn() {
                    return this.enabled ? Function.prototype.bind.call(console.warn, console) : Kt
                }
                get error() {
                    return this.enabled ? Function.prototype.bind.call(console.error, console) : Kt
                }
            }
            class Gt {
                constructor(e) {
                    ...
                    t(this, "toggleFallback", ((t=!1)=>{
                        ...
                        nt(this.target, this.player.config.classNames.fullscreen.fallback, t),
                        V.isIos) {
                            ...
                            t ? (this.cleanupViewport = !n,
                            n || (e.content += `,${i}`)) : this.cleanupViewport && (e.content = e.content.split(",").filter((t=>t.trim() !== i)).join(","))
                        }
                        this.onChange()
                    }
                    )),
                    t(this, "trapFocus", (t=>{
                        ...
                        const e = document.activeElement
                          ...
                          , [n] = i
                          , s = i[i.length - 1];
                        e !== s || t.shiftKey ? e === n && t.shiftKey && (s.focus(),
                    ...
                    t(this, "update", (()=>{
                        if (this.enabled) {
                            let t;
                            t = this.forceFallback ? "Fallback (forced)" : Gt.native ? "Native" : "Fallback",
                    ...
                    pt.call(this.player, document, "ms" === this.prefix ? "MSFullscreenChange" : `${this.prefix}fullscreenchange`, (()=>{
                        this.onChange()
                    }
                    )),
                    pt.call(this.player, this.player.elements.container, "dblclick", (t=>{
                        H(this.player.elements.controls) && this.player.elements.controls.contains(t.target) || this.player.listeners.proxy(t, this.toggle, "fullscreen")
                    }
                    )),
                    pt.call(this, this.player.elements.container, "keydown", (t=>this.trapFocus(t))),
                    this.update()
                }
                static get native() {
                ...
                static get prefix() {
                    if (I(document.exitFullscreen))
                        return "";
                    let t = "";
                    return ["webkit", "moz", "ms"].some((e=>!(!I(document[`${e}ExitFullscreen`]) && !I(document[`${e}CancelFullScreen`]) || (t = e,
                    0)))),
                    t
                }
                static get property() {
                ...
                get enabled() {
                    return (Gt.native || this.player.config.fullscreen.fallback) && this.player.config.fullscreen.enabled && this.player.supported.ui && this.player.isVideo
                }
                get active() {
                    if (!this.enabled)
                        return !1;
                    if (!Gt.native || this.forceFallback)
                        return st(this.target, this.player.config.classNames.fullscreen.fallback);
            ...
            const Zt = {
                addStyleHook() {
                    nt(this.elements.container, this.config.selectors.container.replace(".", ""), !0),
                    nt(this.elements.container, this.config.classNames.uiSupported, this.supported.ui)
                },
                ...
                build() {
                    ...
                    H(this.elements.controls) || (Bt.inject.call(this),
                    ...
                    nt(this.elements.container, this.config.classNames.pip.supported, ut.pip && this.isHTML5 && this.isVideo),
                    nt(this.elements.container, this.config.classNames.airplay.supported, ut.airplay && this.isHTML5),
                    nt(this.elements.container, this.config.classNames.isIos, V.isIos),
                    nt(this.elements.container, this.config.classNames.isTouch, this.touch),
                    this.ready = !0,
                    setTimeout((()=>{
                    ...
                    this.poster && Zt.setPoster.call(this, this.poster, !1).catch((()=>{}
                    )),
                    this.config.duration && Bt.durationUpdate.call(this)
                },
                setTitle() {
                    let t = Dt.get("play", this.config);
                    if (M(this.config.title) && !$(this.config.title) && (t += `, ${this.config.title}`),
                ...
                setPoster(t, e=!0) {
                    ...
                    vt.call(this).then((()=>Jt(t))).catch((e=>{
                        throw t === this.poster && Zt.togglePoster.call(this, !1),
                        e
                    }
                    )).then((()=>{
                        if (t !== this.poster)
                ...
                checkPlaying(t) {
                    nt(this.elements.container, this.config.classNames.playing, this.playing),
                    nt(this.elements.container, this.config.classNames.paused, this.paused),
                    nt(this.elements.container, this.config.classNames.stopped, this.stopped),
                    Array.from(this.elements.buttons.play || []).forEach((t=>{
                        Object.assign(t, {
                            pressed: this.playing
                        }),
                        t.setAttribute("aria-label", Dt.get(this.playing ? "pause" : "play", this.config))
                    }
                    )),
                    F(t) && "timeupdate" === t.type || Zt.toggleControls.call(this)
                },
                checkLoading(t) {
                    this.loading = ["stalled", "waiting"].includes(t.type),
                    clearTimeout(this.timers.loading),
                    this.timers.loading = setTimeout((()=>{
                        nt(this.elements.container, this.config.classNames.loading, this.loading),
                ...
                migrateStyles() {
                    Object.values({
                        ...this.media.style
                    }).filter((t=>!$(t) && M(t) && t.startsWith("--plyr"))).forEach((t=>{
            ...
            class te {
                constructor(e) {
                    ...
                    t(this, "global", ((t=!0)=>{
                        const {player: e} = this;
                        e.config.keyboard.global && dt.call(e, window, "keydown keyup", this.handleKey, t, !1),
                        dt.call(e, document.body, "click", this.toggleMenu, t),
                        mt.call(e, document.body, "touchstart", this.firstTouch),
                        dt.call(e, document.body, "keydown focus blur focusout", this.setTabFocus, t, !1, !0)
                    }
                    )),
                    t(this, "container", (()=>{
                        const {player: t} = this
                          , {config: e, elements: i, timers: n} = t;
                        !e.keyboard.global && e.keyboard.focused && pt.call(t, i.container, "keydown keyup", this.handleKey, !1),
                        pt.call(t, i.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", (e=>{
                            const {controls: s} = i;
                            s && "enterfullscreen" === e.type && (s.pressed = !1,
                            s.hover = !1);
                            let o = 0;
                            ["touchstart", "touchmove", "mousemove"].includes(e.type) && (Zt.toggleControls.call(t, !0),
                            o = t.touch ? 3e3 : 2e3),
                            clearTimeout(n.controls),
                            n.controls = setTimeout((()=>Zt.toggleControls.call(t, !1)), o)
                        }
                        ));
                        const s = ()=>{
                            ...
                            if (!n)
                                return void (r ? (e.style.width = null,
                            ...
                            const [a,l] = [Math.max(document.documentElement.clientWidth || 0, window.innerWidth || 0), Math.max(document.documentElement.clientHeight || 0, window.innerHeight || 0)]
                              , c = a / l > s / o;
                            r ? (e.style.width = c ? "auto" : "100%",
                            e.style.height = c ? "100%" : "auto") : (e.style.maxWidth = c ? l / o * s + "px" : null,
                        ...
                        pt.call(t, i.container, "enterfullscreen exitfullscreen", (e=>{
                            ...
                            n === i.container && (!t.isEmbed && $(t.config.ratio) || (s(),
                            ("enterfullscreen" === e.type ? pt : ft).call(t, window, "resize", o)))
                        }
                        ))
                    }
                    )),
                    t(this, "media", (()=>{
                        const {player: t} = this
                          , {elements: e} = t;
                        if (pt.call(t, t.media, "timeupdate seeking seeked", (e=>Bt.timeUpdate.call(t, e))),
                        pt.call(t, t.media, "durationchange loadeddata loadedmetadata", (e=>Bt.durationUpdate.call(t, e))),
                        pt.call(t, t.media, "ended", (()=>{
                            t.isHTML5 && t.isVideo && t.config.resetOnEnd && (t.restart(),
                            t.pause())
                        }
                        )),
                        pt.call(t, t.media, "progress playing seeking seeked", (e=>Bt.updateProgress.call(t, e))),
                        pt.call(t, t.media, "volumechange", (e=>Bt.updateVolume.call(t, e))),
                        pt.call(t, t.media, "playing play pause ended emptied timeupdate", (e=>Zt.checkPlaying.call(t, e))),
                        pt.call(t, t.media, "waiting canplay seeked playing", (e=>Zt.checkLoading.call(t, e))),
                        t.supported.ui && t.config.clickToPlay && !t.isAudio) {
                            const i = at.call(t, `.${t.config.classNames.video}`);
                            if (!H(i))
                                return;
                            pt.call(t, e.container, "click", (n=>{
                                ([e.container, i].includes(n.target) || i.contains(n.target)) && (t.touch && t.config.hideControls || (t.ended ? (this.proxy(n, t.restart, "restart"),
                                this.proxy(n, (()=>{
                                    bt(t.play())
                                }
                                ), "play")) : this.proxy(n, (()=>{
                    ...
                    t(this, "controls", (()=>{
                        ...
                        this.bind(e.buttons.settings, "keyup", (e=>{
                            ...
                            e.stopPropagation(),
                            Bt.toggleMenu.call(t, e)) : Bt.focusFirstMenuItem.call(t, null, !0))
                        }
                        ), null, !1),
                        ...
                        this.bind(e.inputs.seek, "mousedown mouseup keydown keyup touchstart touchend", (e=>{
                            ...
                            bt(t.play())) : !r && t.playing && (i.setAttribute(s, ""),
                            t.pause())
                        }
                        )),
                        V.isIos) {
                        ...
                        this.bind(e.progress, "mouseenter mouseleave mousemove", (e=>Bt.updateSeekTooltip.call(t, e))),
                        ...
                        V.isWebkit && Array.from(rt.call(t, 'input[type="range"]')).forEach((e=>{
                            this.bind(e, "input", (e=>Bt.updateRangeFill.call(t, e.target)))
                        }
                        )),
                        t.config.toggleInvert && !H(e.display.duration) && this.bind(e.display.currentTime, "click", (()=>{
                        ...
                        this.bind(e.controls, "focusin", (()=>{
                            ...
                            clearTimeout(n.controls),
                            n.controls = setTimeout((()=>Zt.toggleControls.call(t, !1)), s)
                        }
                        )),
                        this.bind(e.inputs.volume, "wheel", (e=>{
                            ...
                            (1 === o && r < 1 || -1 === o && r > 0) && e.preventDefault()
                        }
                        ), "volume", !1)
                    }
                    )),
                ...
                handleKey(t) {
                    ...
                    if (!(t.altKey || t.ctrlKey || t.metaKey || t.shiftKey) && O(n))
                        if (s) {
                            ...
                            switch ([32, 37, 38, 39, 40, 48, 49, 50, 51, 52, 53, 54, 56, 57, 67, 70, 73, 75, 76, 77, 79].includes(n) && (t.preventDefault(),
                            t.stopPropagation()),
                            n) {
                            case 48:
                            case 49:
                            ...
                            27 === n && !e.fullscreen.usingNative && e.fullscreen.active && e.fullscreen.toggle(),
                            this.lastKey = n
                        } else
                            this.lastKey = null
                }
            ...
            var ee = function(t, e) {
                return function(t, e) {
                    t.exports = function() {
                        ...
                        function a(e, i, n, s) {
                            var o, r, l = document, c = n.async, u = (n.numRetries || 0) + 1, h = n.before || t, d = e.replace(/[\?|#].*$/, ""), p = e.replace(/^(css|img)!/, "");
                            s = s || 0,
                            /(^css!|\.css$)/.test(d) ? ((r = l.createElement("link")).rel = "stylesheet",
                            r.href = p,
                            (o = "hideFocus"in r) && r.relList && (o = 0,
                            r.rel = "preload",
                            r.as = "style")) : /(^img!|\.(png|gif|jpg|svg|webp)$)/.test(d) ? (r = l.createElement("img")).src = p : ((r = l.createElement("script")).src = e,
                            r.async = void 0 === c || c),
                        ...
                        function l(t, e, i) {
                            var n, s, o = (t = t.push ? t : [t]).length, r = o, l = [];
            ...
            const se = {
                setup() {
                    ...
                    t.options.speed = t.config.speed.options,
                    St.call(t),
                    P(window.Vimeo) ? se.ready.call(t) : ie(t.config.urls.vimeo.sdk).then((()=>{
                        se.ready.call(t)
                    }
                    )).catch((e=>{
                ...
                ready() {
                    ...
                    const a = $(l = r) ? null : O(Number(l)) ? l : l.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : l;
                    var l;
                    const c = X("iframe")
                      , u = Pt(t.config.urls.vimeo.iframe, a, o);
                    if (c.setAttribute("src", u),
                    ...
                    e.customControls || Ht(Pt(t.config.urls.vimeo.api, u)).then((e=>{
                        !$(e) && e.thumbnail_url && Zt.setPoster.call(t, e.thumbnail_url).catch((()=>{}
                        ))
                    }
                    )),
                    ...
                    t.media.play = ()=>(ne.call(t, !0),
                    t.embed.play()),
                    t.media.pause = ()=>(ne.call(t, !1),
                    t.embed.pause()),
                    t.media.stop = ()=>{
                        t.pause(),
                        t.currentTime = 0
                    ...
                    Object.defineProperty(t.media, "currentTime", {
                        ...
                        set(e) {
                            ...
                            n.seeking = !0,
                            gt.call(t, n, "seeking"),
                            Promise.resolve(r && i.setVolume(0)).then((()=>i.setCurrentTime(e))).then((()=>r && i.pause())).then((()=>r && i.setVolume(o))).catch((()=>{}
                            ))
                        }
                    });
            ...
            const ae = {
                setup() {
                    if (nt(this.elements.wrapper, this.config.classNames.embed, !0),
                ...
                getTitle(t) {
                    Ht(Pt(this.config.urls.youtube.api, t)).then((t=>{
                        if (P(t)) {
                ...
                ready() {
                    ...
                    if (!$(i) && i.startsWith("youtube-"))
                        return;
                    let n = t.media.getAttribute("src");
                    $(n) && (n = t.media.getAttribute(this.config.attributes.embed.id));
                    const s = $(o = n) ? null : o.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : o;
                    var o;
                    const r = X("div", {
                        id: `${t.provider}-${Math.floor(1e4 * Math.random())}`,
                        "data-poster": e.customControls ? t.poster : void 0
                    });
                    if (t.media = tt(r, t.media),
                    e.customControls) {
                        const e = t=>`https://i.ytimg.com/vi/${s}/${t}default.jpg`;
                        Jt(e("maxres"), 121).catch((()=>Jt(e("sd"), 121))).catch((()=>Jt(e("hq")))).then((e=>Zt.setPoster.call(t, e.src))).then((e=>{
                    ...
                    t.embed = new window.YT.Player(t.media,{
                        ...
                        events: {
                            ...
                            onReady(i) {
                                ...
                                e.customControls && setTimeout((()=>Zt.build.call(t)), 50)
                            },
                            onStateChange(i) {
                                const n = i.target;
                                ...
                                case 0:
                                    oe.call(t, !1),
                                    t.media.loop ? (n.stopVideo(),
                                    n.playVideo()) : gt.call(t, t.media, "ended");
                                    break;
                                case 1:
                                    e.customControls && !t.config.autoplay && t.media.paused && !t.embed.hasPlayed ? t.media.pause() : (oe.call(t, !0),
                                    gt.call(t, t.media, "playing"),
                                    t.timers.playing = setInterval((()=>{
                                        gt.call(t, t.media, "timeupdate")
                                    }
                                    ), 50),
                                    t.media.duration !== n.getDuration() && (t.media.duration = n.getDuration(),
                                    gt.call(t, t.media, "durationchange")));
                                    break;
                                case 2:
              ...
              , le = {
                setup() {
                    this.media ? (nt(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0),
                    nt(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0),
                    this.isEmbed && nt(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0),
                    ...
                    this.isHTML5 ? Lt.setup.call(this) : this.isYouTube ? ae.setup.call(this) : this.isVimeo && se.setup.call(this)) : this.debug.warn("No media element found!")
                }
            };
            class ce {
                constructor(e) {
                    ...
                    t(this, "pollCountdown", ((t=!1)=>{
                        ...
                        this.countdownTimer = setInterval((()=>{
                            const t = Rt(Math.max(this.manager.getRemainingTime(), 0))
                              , e = `${Dt.get("advertisement", this.player.config)} - ${t}`;
                    ...
                    t(this, "addCuePoints", (()=>{
                        $(this.cuePoints) || this.cuePoints.forEach((t=>{
                    ...
                    t(this, "listeners", (()=>{
                        ...
                        this.player.on("seeked", (()=>{
                            ...
                            $(this.cuePoints) || this.cuePoints.forEach(((i,n)=>{
                    ...
                    t(this, "on", ((t,e)=>(D(this.events[t]) || (this.events[t] = []),
                    ...
                    t(this, "clearSafetyTimer", (t=>{
                        L(this.safetyTimer) || (this.player.debug.log(`Safety timer cleared from: ${t}`),
                ...
                get enabled() {
                    const {config: t} = this;
                    return this.player.isHTML5 && this.player.isVideo && t.enabled && (!$(t.publisherId) || B(t.tagUrl))
                }
                get tagUrl() {
                    const {config: t} = this;
                    return B(t.tagUrl) ? t.tagUrl : `https://go.aniview.com/api/adserver6/vast/?${qt({
            ...
            class de {
                constructor(e) {
                    ...
                    t(this, "startMove", (t=>{
                        if (this.loaded && F(t) && ["touchmove", "mousemove"].includes(t.type) && this.player.media.duration) {
                            if ("touchmove" === t.type)
                                ...
                                this.elements.thumb.time.innerText = Rt(this.seekTime)
                            }
                    ...
                    t(this, "startScrubbing", (t=>{
                        (L(t.button) || !1 === t.button || 0 === t.button) && (this.mouseDown = !0,
                    ...
                    t(this, "showImage", ((t,e,i,n,s,o=!0)=>{
                        ...
                        o && (this.currentImageContainer.appendChild(t),
                        this.currentImageElement = t,
                        this.loadedImages.includes(s) || this.loadedImages.push(s)),
                        this.preloadNearby(n, !0).then(this.preloadNearby(n, !1)).then(this.getHigherQuality(i, t, e, s))
                    }
                    )),
            ...
            const pe = {
                ...
                change(t) {
                    U(t, "sources.length") ? (Lt.cancelRequests.call(this),
                    this.destroy.call(this, (()=>{
                        ...
                        (this.isHTML5 || this.isEmbed && !this.supported.ui) && Zt.build.call(this),
                        this.isHTML5 && this.media.load(),
                        $(t.previewThumbnails) || (Object.assign(this.config.previewThumbnails, t.previewThumbnails),
                        this.previewThumbnails && this.previewThumbnails.loaded && (this.previewThumbnails.destroy(),
                        this.previewThumbnails = null),
                        this.config.previewThumbnails.enabled && (this.previewThumbnails = new de(this))),
            ...
            class fe {
                constructor(e, i) {
                    if (t(this, "play", (()=>I(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then((()=>this.ads.play())).catch((()=>bt(this.media.play()))),
                    this.media.play()) : null)),
                    t(this, "pause", (()=>this.playing && I(this.media.pause) ? this.media.pause() : null)),
                    t(this, "togglePlay", (t=>(N(t) ? t : !this.playing) ? this.play() : this.pause())),
                    t(this, "stop", (()=>{
                        this.isHTML5 ? (this.pause(),
                        this.restart()) : I(this.media.stop) && this.media.stop()
                    }
                    )),
                    t(this, "restart", (()=>{
                        this.currentTime = 0
                    ...
                    t(this, "toggleControls", (t=>{
                        if (this.supported.ui && !this.isAudio) {
                            ...
                            if (n && D(this.config.controls) && this.config.controls.includes("settings") && !$(this.config.settings) && Bt.toggleMenu.call(this, !1),
                            n !== e) {
                    ...
                    t(this, "destroy", ((t,e=!1)=>{
                        ...
                        const i = ()=>{
                            ...
                            this.embed = null,
                            e ? (Object.keys(this.elements).length && (J(this.elements.buttons.play),
                        ...
                        this.isHTML5 ? (Zt.toggleNativeControls.call(this, !0),
                        i()) : this.isYouTube ? (clearInterval(this.timers.buffering),
                        clearInterval(this.timers.playing),
                        null !== this.embed && I(this.embed.destroy) && this.embed.destroy(),
                    ...
                    (window.jQuery && this.media instanceof jQuery || j(this.media) || D(this.media)) && (this.media = this.media[0]),
                    this.config = Y({}, Vt, fe.defaults, i || {}, (()=>{
                        try {
                    ...
                    case "div":
                        ...
                        H(o)) {
                            if (r = $t(o.getAttribute("src")),
                            this.provider = function(t) {
                                return /^(https?:\/\/)?(www\.)?(youtube\.com|youtube-nocookie\.com|youtu\.?be)\/.+$/.test(t) ? Yt.youtube : /^https?:\/\/player.vimeo.com\/video\/\d{0,9}(?=\b|\/)/.test(t) ? Yt.vimeo : null
                            }(r.toString()),
                            ...
                            r.search.length) {
                                const t = ["1", "true"];
                                t.includes(r.searchParams.get("autoplay")) && (this.config.autoplay = !0),
                                t.includes(r.searchParams.get("loop")) && (this.config.loop.active = !0),
                                this.isYouTube ? (this.config.playsinline = t.includes(r.searchParams.get("playsinline")),
                                this.config.youtube.hl = r.searchParams.get("hl")) : this.config.playsinline = !0
                            }
                        } else
                            this.provider = this.media.getAttribute(this.config.attributes.embed.provider),
                            this.media.removeAttribute(this.config.attributes.embed.provider);
                        if ($(this.provider) || !Object.values(Yt).includes(this.provider))
                    ...
                    this.supported = ut.check(this.type, this.provider, this.config.playsinline),
                    this.supported.api ? (this.eventListeners = [],
                    this.listeners = new te(this),
                    this.storage = new jt(this),
                    this.media.plyr = this,
                    H(this.elements.container) || (this.elements.container = X("div", {
                        tabindex: 0
                    }),
                    ...
                    Zt.addStyleHook.call(this),
                    le.setup.call(this),
                    this.config.debug && pt.call(this, this.elements.container, this.config.events.join(" "), (t=>{
                    ...
                    this.lastSeekTime = 0,
                    this.config.previewThumbnails.enabled && (this.previewThumbnails = new de(this))) : this.debug.error("Setup failed: no support")
                }
                get isHTML5() {
                ...
                get buffered() {
                    ...
                    return O(t) ? t : t && t.length && this.duration > 0 ? t.end(0) / this.duration : 0
                }
                get seeking() {
                ...
                set quality(t) {
                    ...
                    if (!i.length)
                        return;
                    let n = [!$(t) && Number(t), this.storage.get("quality"), e.selected, e.default].find(O)
                      , s = !0;
                    if (!i.includes(n)) {
                        const t = _t(i, n);
                        this.debug.warn(`Unsupported quality option: ${n}, using ${t} instead`),
                        n = t,
                        s = !1
                    }
                    e.selected = n,
                ...
                set download(t) {
                    B(t) && (this.config.urls.download = t,
                    Bt.setDownloadUrl.call(this))
                }
                set poster(t) {
                    this.isVideo ? Zt.setPoster.call(this, t, !1).catch((()=>{}
                ...
                set ratio(t) {
                    this.isVideo ? M(t) && kt(t) ? (this.config.ratio = Tt(t),
                    St.call(this)) : this.debug.error(`Invalid aspect ratio specified (${t})`) : this.debug.warn("Aspect ratio can only be set for video")
                }
                set autoplay(t) {
                ...
                set pip(t) {
                    ...
                    I(this.media.webkitSetPresentationMode) && this.media.webkitSetPresentationMode(e ? Ut : "inline"),
                    I(this.media.requestPictureInPicture) && (!this.pip && e ? this.media.requestPictureInPicture() : this.pip && !e && document.exitPictureInPicture())
                }
                get pip() {
                    return ut.pip ? $(this.media.webkitPresentationMode) ? this.media === document.pictureInPictureElement : this.media.webkitPresentationMode === Ut : null
                }
                ...
                static setup(t, e={}) {
                    let i = null;
                    return M(t) ? i = Array.from(document.querySelectorAll(t)) : j(t) ? i = Array.from(t) : D(t) && (i = t.filter(H)),
                    $(i) ? null : i.map((t=>new fe(t,e)))
                }
            }
            var me;
            return fe.defaults = (me = Vt,
            ...
            "undefined" != typeof Prism && "undefined" != typeof document && (Prism.plugins.toolbar ? Prism.plugins.toolbar.registerButton("copy-to-clipboard", (function(e) {
                var i = e.element
                  , n = function(t) {
                    ...
                    for (var i in e) {
                        for (var n = "data-prismjs-" + i, s = t; s && !s.hasAttribute(n); )
                            s = s.parentElement;
    ...
    781: t=>{
        !function() {
            if ("undefined" != typeof Prism && "undefined" != typeof document) {
                var e = Object.assign || function(t, e) {
                    for (var i in e)
                ...
                i.prototype = {
                    ...
                    normalize: function(t, i) {
                        for (var n in i = e(this.defaults, i)) {
                            ...
                            "normalize" !== n && "setDefaults" !== s && i[n] && this[s] && (t = this[s].call(this, t, i[n]))
                        }
                        return t
                    },
                    leftTrim: function(t) {
                    ...
                    removeIndent: function(t) {
                        ...
                        e[0].length ? t.replace(RegExp("^" + e[0], "gm"), "") : t) : t
                    },
                    indent: function(t, e) {
                    ...
                    breakLines: function(t, e) {
                        ...
                        for (var i = t.split("\n"), s = 0; s < i.length; ++s)
                            if (!(n(i[s]) <= e)) {
                                for (var o = i[s].split(/(\s+)/g), r = 0, a = 0; a < o.length; ++a) {
                                    var l = n(o[a]);
                                    (r += l) > e && (o[a] = "\n" + o[a],
                                    r = l)
                                }
                ...
                "undefined" != typeof Prism && (Prism.plugins.NormalizeWhitespace = new i({
                    "remove-trailing": !0,
                    "remove-indent": !0,
                    "left-trim": !0,
                    "right-trim": !0
                ...
                Prism.hooks.add("before-sanity-check", (function(t) {
                    ...
                    if ((!t.settings || !1 !== t.settings["whitespace-normalization"]) && Prism.util.isActive(t.element, "whitespace-normalization", !0))
                        if (t.element && t.element.parentNode || !t.code) {
                            var i = t.element.parentNode;
                            if (t.code && i && "pre" === i.nodeName.toLowerCase()) {
                                for (var n = i.childNodes, s = "", o = "", r = !1, a = 0; a < n.length; ++a) {
                                    var l = n[a];
                                    l == t.element ? r = !0 : "#text" === l.nodeName && (r ? o += l.nodeValue : s += l.nodeValue,
                                    i.removeChild(l),
                                    --a)
                                }
        ...
        !function() {
            if ("undefined" != typeof Prism && "undefined" != typeof document) {
                ...
                var n = Prism.plugins.toolbar.registerButton = function(i, n) {
                    var s;
                    s = "function" == typeof n ? n : function(t) {
                        var e;
                    ...
                    ,
                    i in e ? console.warn('There is a button with the key "' + i + '" registered already.') : t.push(e[i] = s)
                }
                ...
                n("label", (function(t) {
                    ...
                    if (e && /pre/i.test(e.nodeName) && e.hasAttribute("data-label")) {
                        ...
                        return n ? i = n.content : (e.hasAttribute("data-url") ? (i = document.createElement("a")).href = e.getAttribute("data-url") : i = document.createElement("span"),
                        i.textContent = s),
                        i
                    }
                }
    ...
    439: ()=>{
        ...
        Prism.hooks.add("before-highlightall", (function(t) {
            t.selector += ', [class*="lang-"] script[type="text/plain"], [class*="language-"] script[type="text/plain"], script[type="text/plain"][class*="lang-"], script[type="text/plain"][class*="language-"]'
        }
        )),
        Prism.hooks.add("before-sanity-check", (function(t) {
            var e = t.element;
            if (e.matches('script[type="text/plain"]')) {
                ...
                return Object.keys(s || {}).forEach((function(t) {
                    Object.prototype.hasOwnProperty.call(s, t) && (n.dataset[t] = s[t])
                }
                )),
                i.textContent = t.code = t.code.replace(/&lt;\/script(?:>|&gt;)/gi, "<\/script>"),
                n.appendChild(i),
            ...
            if (!t.code) {
                var o = e.childNodes;
                1 === o.length && "#comment" == o[0].nodeName && (e.textContent = t.code = o[0].textContent)
            }
        }
        )))
    }
        ...
        var n = function(t) {
            var e = /\blang(?:uage)?-([\w-]+)\b/i
              ...
              , s = {
                ...
                util: {
                    encode: function t(e) {
                        return e instanceof o ? new o(e.type,t(e.content),e.alias) : Array.isArray(e) ? e.map(t) : e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ")
                    },
                    type: function(t) {
                    ...
                    DFS: function t(e, i, n, o) {
                        ...
                        for (var a in e)
                            if (e.hasOwnProperty(a)) {
                                ...
                                var l = e[a]
                                  , c = s.util.type(l);
                                "Object" !== c || o[r(l)] ? "Array" !== c || o[r(l)] || (o[r(l)] = !0,
                                t(l, i, a, o)) : (o[r(l)] = !0,
                                t(l, i, null, o))
                            }
                    }
                ...
                highlightElement: function(i, n, o) {
                    var r = s.util.getLanguage(i)
                      , a = s.languages[r];
                    i.className = i.className.replace(e, "").replace(/\s+/g, " ") + " language-" + r;
                    var l = i.parentElement;
                    l && "pre" === l.nodeName.toLowerCase() && (l.className = l.className.replace(e, "").replace(/\s+/g, " ") + " language-" + r);
                    var c = {
                        element: i,
                        language: r,
                        grammar: a,
                    ...
                    if (s.hooks.run("before-sanity-check", c),
                    (l = c.element.parentElement) && "pre" === l.nodeName.toLowerCase() && !l.hasAttribute("tabindex") && l.setAttribute("tabindex", "0"),
                    !c.code)
                        return s.hooks.run("complete", c),
                        void (o && o.call(c.element));
                    if (s.hooks.run("before-highlight", c),
                    c.grammar)
                        if (n && t.Worker) {
                            ...
                            u(s.highlight(c.code, c.grammar, c.language));
                    else
                        u(s.util.encode(c.code))
                },
                ...
                for (var d in i)
                    if (i.hasOwnProperty(d) && i[d]) {
                        ...
                        for (var f = 0; f < p.length; ++f) {
                            ...
                            for (var _ = m.pattern || m, E = n.next, x = l; E !== e.tail && !(h && x >= h.reach); x += E.value.length,
                            E = E.next) {
                                var k = E.value;
                                ...
                                if (!(k instanceof o)) {
                                    ...
                                    if (v) {
                                        ...
                                        if (x = L -= E.value.length,
                                        E.value instanceof o)
                                            continue;
                                        for (var P = E; P !== e.tail && (L < A || "string" == typeof P.value); P = P.next)
                                            C++,
                                            L += P.value.length;
                                        C--,
                                        k = t.slice(x, L),
            ...
            function u(t, e, i) {
                for (var n = e.next, s = 0; s < i && n !== t.tail; s++)
                    n = n.next;
                e.next = n,
                n.prev = e,
                t.length -= s
            ...
            if (h && (s.filename = h.src,
            h.hasAttribute("data-manual") && (s.manual = !0)),
            !s.manual) {
                var p = document.readyState;
                "loading" === p || "interactive" === p && h && h.defer ? document.addEventListener("DOMContentLoaded", d) : window.requestAnimationFrame ? window.requestAnimationFrame(d) : window.setTimeout(d, 16)
            }
            return s
            ...
            if (void 0 !== n && "undefined" != typeof document) {
                ...
                n.hooks.add("before-sanity-check", (function(s) {
                    ...
                    if (o.matches(i)) {
                        ...
                        d.onreadystatechange = function() {
                            4 == d.readyState && (d.status < 400 && d.responseText ? (o.setAttribute(e, "loaded"),
                            a.textContent = d.responseText,
                            n.highlightElement(a)) : (o.setAttribute(e, "failed"),
                            d.status >= 400 ? a.textContent = "✖ Error " + d.status + " while fetching file: " + d.statusText : a.textContent = "✖ Error: File does not exist or is empty"))
                        }
                        ,
                        d.send(null)
                    }
                ...
                n.plugins.fileHighlight = {
                    highlight: function(t) {
                        for (var e, s = (t || document).querySelectorAll(i), o = 0; e = s[o++]; )
            ...
            return function(t) {
                ...
                return function(a, l) {
                    var c, u, h, d, p = {
                        ...
                        animateScroll: function(n, a, l) {
                            ...
                            if (f || m) {
                                ...
                                var y, v, b, w, _, E, x, k, T = function(e) {
                                    return e ? (i = e,
                                    parseInt(t.getComputedStyle(i).height, 10) + e.offsetTop) : 0;
                                    var i
                                }(h), C = f ? n : function(e, i, n, o) {
                                    var r = 0;
                                    if (e.offsetParent)
                                        for (; r += e.offsetTop,
                                        e = e.offsetParent; )
                                    ...
                                    r
                                }(m, T, parseInt("function" == typeof u.offset ? u.offset(n, a) : u.offset, 10), u.clip), S = C - g, A = s(), L = 0, P = (y = S,
                                b = (v = u).speedAsDuration ? v.speed : Math.abs(y / 1e3 * v.speed),
                                v.durationMax && b > v.durationMax ? v.durationMax : v.durationMin && b < v.durationMin ? v.durationMin : parseInt(b, 10)), O = function(e) {
                                    var i, s, l;
                                    w || (w = e),
                                    L += e - w,
                                    E = g + S * (s = _ = 1 < (_ = 0 === P ? 0 : L / P) ? 1 : _,
                                    "easeInQuad" === (i = u).easing && (l = s * s),
                                    "easeOutQuad" === i.easing && (l = s * (2 - s)),
                                    "easeInOutQuad" === i.easing && (l = s < .5 ? 2 * s * s : (4 - 2 * s) * s - 1),
                                    "easeInCubic" === i.easing && (l = s * s * s),
                                    "easeOutCubic" === i.easing && (l = --s * s * s + 1),
                                    "easeInOutCubic" === i.easing && (l = s < .5 ? 4 * s * s * s : (s - 1) * (2 * s - 2) * (2 * s - 2) + 1),
                                    "easeInQuart" === i.easing && (l = s * s * s * s),
                                    "easeOutQuart" === i.easing && (l = 1 - --s * s * s * s),
                                    "easeInOutQuart" === i.easing && (l = s < .5 ? 8 * s * s * s * s : 1 - 8 * --s * s * s * s),
                                    "easeInQuint" === i.easing && (l = s * s * s * s * s),
                                    "easeOutQuint" === i.easing && (l = 1 + --s * s * s * s * s),
                                    "easeInOutQuint" === i.easing && (l = s < .5 ? 16 * s * s * s * s * s : 1 + 16 * --s * s * s * s * s),
                                    i.customEasing && (l = i.customEasing(s)),
                                    l || s),
                                    t.scrollTo(0, Math.floor(E)),
                                    function(e, i) {
                                        var s = t.pageYOffset;
                                        if (e == i || s == i || (g < i && t.innerHeight + s) >= A)
                                            return p.cancelScroll(!0),
                                            o(n, i, f),
                                            r("scrollStop", u, n, a),
                                            !(d = w = null)
                                    }(E, C) || (d = t.requestAnimationFrame(O),
                                    w = e)
                                };
                                0 === t.pageYOffset && t.scrollTo(0, 0),
                                x = n,
                                k = u,
                                f || history.pushState && k.updateURL && history.pushState({
                                    smoothScroll: JSON.stringify(k),
                                    anchor: x.id
                                }, document.title, x === document.documentElement ? "#top" : "#" + x.id),
                                "matchMedia"in t && t.matchMedia("(prefers-reduced-motion)").matches ? o(n, Math.floor(C), !1) : (r("scrollStart", u, n, a),
                                p.cancelScroll(!0),
                                t.requestAnimationFrame(O))
                            }
                        }
                    }, f = function(e) {
                        if (!e.defaultPrevented && !(0 !== e.button || e.metaKey || e.ctrlKey || e.shiftKey) && "closest"in e.target && (u = e.target.closest(a)) && "a" === u.tagName.toLowerCase() && !e.target.closest(c.ignore) && u.hostname === t.location.hostname && u.pathname === t.location.pathname && /#/.test(u.href)) {
                            var i, s;
                            try {
                            ...
                            (s = s || "#top" !== i ? s : document.documentElement) && (e.preventDefault(),
                            function(e) {
                    ...
                    return p.destroy = function() {
                        c && (document.removeEventListener("click", f, !1),
                    ...
                    function() {
                        ...
                        c.updateURL && c.popstate && t.addEventListener("popstate", m, !1)
                    }(),
                    p
                }
            }(s)
    ...
    740: (t,e,i)=>{
        ...
        var n = window
          , s = n.requestAnimationFrame || n.webkitRequestAnimationFrame || n.mozRequestAnimationFrame || n.msRequestAnimationFrame || function(t) {
            return setTimeout(t, 16)
        }
          , o = window
          , r = o.cancelAnimationFrame || o.mozCancelAnimationFrame || function(t) {
            clearTimeout(t)
        }
        ;
        function a() {
            for (var t, e, i, n = arguments[0] || {}, s = 1, o = arguments.length; s < o; s++)
        ...
        function d(t) {
            var e = "";
            return t.fake && (e = h.style.overflow,
            t.style.background = "",
        ...
        function P(t) {
            ...
            for (var n = document.createElement("fakeelement"), s = (t.length,
            0); s < t.length; s++) {
                var o = t[s];
                if (void 0 !== n.style[o])
                    return o
        ...
        var F = function(t) {
            ...
            if (h) {
                var y = navigator.userAgent
                  , x = new Date;
                try {
                    (o = i.localStorage) ? (o.setItem(x, x),
                    h = o.getItem(x) == x,
                    o.removeItem(x)) : h = !1,
                    h || (o = {})
                } catch (t) {
                ...
                h && (o.tnsApp && o.tnsApp !== y && ["tC", "tPL", "tMQ", "tTf", "t3D", "tTDu", "tTDe", "tADu", "tADe", "tTE", "tAE"].forEach((function(t) {
                    o.removeItem(t)
                }
                )),
                localStorage.tnsApp = y)
            }
            var M = o.tC ? l(o.tC) : c(o, "tC", function() {
                var t = document
                  , e = u()
                  , i = d(e)
                ...
                e.appendChild(n);
                try {
                    for (var o, r = "(10px * 10)", a = ["calc" + r, "-moz-calc" + r, "-webkit-calc" + r], l = 0; l < 3; l++)
                        if (o = a[l],
                        n.style.width = o,
                        100 === n.offsetWidth) {
                            s = o.replace(r, "");
                ...
                return e.fake ? p(e, i) : n.remove(),
                s
            }(), h)
              , N = o.tPL ? l(o.tPL) : c(o, "tPL", function() {
                var t, e = document, i = u(), n = d(i), s = e.createElement("div"), o = e.createElement("div"), r = "";
                s.className = "tns-t-subp2",
                ...
                s.appendChild(o),
                i.appendChild(s),
                t = Math.abs(s.getBoundingClientRect().left - o.children[67].getBoundingClientRect().left) < 2,
                i.fake ? p(i, n) : s.remove(),
                t
            }(), h)
              , I = o.tMQ ? l(o.tMQ) : c(o, "tMQ", function() {
                if (window.matchMedia || window.msMatchMedia)
                    return !0;
                var t, e = document, i = u(), n = d(i), s = e.createElement("div"), o = e.createElement("style"), r = "@media all and (min-width:1px){.tns-mq-test{position:absolute}}";
                return o.type = "text/css",
                s.className = "tns-mq-test",
                i.appendChild(o),
                i.appendChild(s),
                o.styleSheet ? o.styleSheet.cssText = r : o.appendChild(e.createTextNode(r)),
                t = window.getComputedStyle ? window.getComputedStyle(s).position : s.currentStyle.position,
                i.fake ? p(i, n) : s.remove(),
                "absolute" === t
            }(), h)
              , z = o.tTf ? l(o.tTf) : c(o, "tTf", P("transform"), h)
              , R = o.t3D ? l(o.t3D) : c(o, "t3D", function(t) {
                if (!t)
                    return !1;
                if (!window.getComputedStyle)
                    return !1;
                var e, i = document, n = u(), s = d(n), o = i.createElement("p"), r = t.length > 9 ? "-" + t.slice(0, -9).toLowerCase() + "-" : "";
                return r += "transform",
            ...
            !(t.container.children.length < 1)) {
                ...
                var rt, at, lt = "horizontal" === t.axis, ct = e.createElement("div"), ut = e.createElement("div"), ht = t.container, dt = ht.parentNode, pt = ht.outerHTML, ft = ht.children, mt = ft.length, gt = Oi(), yt = !1;
                X && Ji(),
                J && (ht.className += " tns-vpfix");
                var vt, bt, wt, _t, Et, xt, kt, Tt, Ct = t.autoWidth, St = ji("fixedWidth"), At = ji("edgePadding"), Lt = ji("gutter"), Pt = Ii(), Ot = ji("center"), Mt = Ct ? 1 : Math.floor(ji("items")), Nt = ji("slideBy"), It = t.viewportMax || t.fixedWidthViewportWidth, Dt = ji("arrowKeys"), jt = ji("speed"), Ht = t.rewind, Ft = !Ht && t.loop, zt = ji("autoHeight"), Rt = ji("controls"), Bt = ji("controlsText"), $t = ji("nav"), qt = ji("touch"), Wt = ji("mouseDrag"), Vt = ji("autoplay"), Ut = ji("autoplayTimeout"), Yt = ji("autoplayText"), Qt = ji("autoplayHoverPause"), Kt = ji("autoplayResetOnVisibility"), Xt = (null,
                kt = ji("nonce"),
                Tt = document.createElement("style"),
                kt && Tt.setAttribute("nonce", kt),
                document.querySelector("head").appendChild(Tt),
                Tt.sheet ? Tt.sheet : Tt.styleSheet), Gt = t.lazyload, Jt = t.lazyloadSelector, Zt = [], te = Ft ? (Et = function() {
                    if (Ct || St && !It)
                        return mt - 1;
                    var e = St ? "fixedWidth" : "items"
                      , i = [];
                    if ((St || t[e] < mt) && i.push(t[e]),
                    X)
                        for (var n in X) {
                            var s = X[n][e];
                            s && (St || s < mt) && i.push(s)
                    ...
                    Math.ceil(St ? It / Math.min.apply(null, i) : Math.max.apply(null, i))
                }(),
                xt = J ? Math.ceil((5 * Et - mt) / 2) : 4 * Et - mt,
                xt = Math.max(Et, xt),
                Di("edgePadding") ? xt + 1 : xt) : 0, ee = J ? mt + 2 * te : mt + te, ie = !(!St && !Ct || Ft), ne = St ? Tn() : null, se = !J || !Ft, oe = lt ? "left" : "top", re = "", ae = "", le = St ? function() {
                ...
                : function() {
                    return Ot && J && !Ft ? mt - 1 : Ft || J ? Math.max(0, ee - Math.ceil(Mt)) : ee - 1
                }
                , ce = Ai(ji("startIndex")), ue = ce, he = (Si(),
                0), de = Ct ? null : le(), pe = t.preventActionWhenRunning, fe = t.swipeAngle, me = !fe || "?", ge = !1, ye = t.onInit, ve = new H, be = " tns-slider tns-" + t.mode, we = ht.id || (_t = window.tnsId,
                window.tnsId = _t ? _t + 1 : 1,
                "tns" + window.tnsId), _e = ji("disable"), Ee = !1, xe = t.freezable, ke = !(!xe || Ct) && Gi(), Te = !1, Ce = {
                    click: In,
                    keydown: function(t) {
                        t = $n(t);
                        var e = [n.LEFT, n.RIGHT].indexOf(t.keyCode);
                        e >= 0 && (0 === e ? Qe.disabled || In(t, -1) : Ke.disabled || In(t, 1))
                    }
                }, Se = {
                    click: function(t) {
                        if (ge) {
                    ...
                    keydown: function(t) {
                        ...
                        if (_(i, "data-nav")) {
                            var s = [n.LEFT, n.RIGHT, n.ENTER, n.SPACE].indexOf(t.keyCode)
                              , o = Number(E(i, "data-nav"));
                            s >= 0 && (0 === s ? o > 0 && Bn(Je[o - 1]) : 1 === s ? o < ei - 1 && Bn(Je[o + 1]) : (ni = o,
                            Nn(o, t)))
                        }
                    }
                }, Ae = {
                    ...
                    mouseup: Xn,
                    mouseleave: Xn
                }, Ne = Di("controls"), Ie = Di("nav"), De = !!Ct || t.navAsThumbnails, je = Di("autoplay"), He = Di("touch"), Fe = Di("mouseDrag"), ze = "tns-slide-active", Re = "tns-slide-cloned", Be = "tns-complete", $e = {
                    load: function(t) {
                        ln(qn(t))
                    },
                    error: function(t) {
                ...
                if (Ne)
                    var We, Ve, Ue = t.controlsContainer, Ye = t.controlsContainer ? t.controlsContainer.outerHTML : "", Qe = t.prevButton, Ke = t.nextButton, Xe = t.prevButton ? t.prevButton.outerHTML : "", Ge = t.nextButton ? t.nextButton.outerHTML : "";
                if (Ie)
                    var Je, Ze = t.navContainer, ti = t.navContainer ? t.navContainer.outerHTML : "", ei = Ct ? mt : Jn(), ii = 0, ni = -1, si = Pi(), oi = si, ri = "tns-nav-active", ai = "Carousel Page ", li = " (Current Slide)";
                if (je)
                    var ci, ui, hi, di, pi, fi = "forward" === t.autoplayDirection ? 1 : -1, mi = t.autoplayButton, gi = t.autoplayButton ? t.autoplayButton.outerHTML : "", yi = ["<span class='tns-visually-hidden'>", " animation</span>"];
                if (He || Fe)
                    var vi, bi, wi = {}, _i = {}, Ei = !1, xi = lt ? function(t, e) {
                        return t.x - e.x
                    }
                    : function(t, e) {
                        return t.y - e.y
                ...
                function() {
                    ...
                    be += " tns-" + t.axis,
                    ht.className += be,
                    J ? ((rt = e.createElement("div")).id = we + "-mw",
                    rt.className = "tns-ovh",
                    ct.appendChild(rt),
                    rt.appendChild(ut)) : ct.appendChild(ut),
                    ...
                    te) {
                        for (var i = e.createDocumentFragment(), n = e.createDocumentFragment(), s = te; s--; ) {
                            var o = s % mt
                              , r = ft[o].cloneNode(!0);
                            if (b(r, Re),
                            T(r, "id"),
                ...
                function() {
                    ...
                    if (lt && (N || Ct ? (f(Xt, "#" + we + " > .tns-item", "font-size:" + i.getComputedStyle(ft[0]).fontSize + ";", m(Xt)),
                    f(Xt, "#" + we, "font-size:0;", m(Xt))) : J && g(ft, (function(t, e) {
                        t.style.marginLeft = function(t) {
                            return M ? M + "(" + 100 * t + "% / " + ee + ")" : 100 * t / ee + "%"
                        }(e)
                    }
                    ))),
                    I) {
                        ...
                        o = Hi(t.edgePadding, t.gutter, t.fixedWidth, t.speed, t.autoHeight),
                        f(Xt, "#" + we + "-iw", o, m(Xt)),
                        J && (o = lt && !Ct ? "width:" + Fi(t.fixedWidth, t.gutter, t.items) + ";" : "",
                        B && (o += $i(jt)),
                        f(Xt, "#" + we, o, m(Xt))),
                    ...
                    if (X && I)
                        for (var r in X) {
                            ...
                            "")
                              ...
                              , _ = ji("autoHeight", r)
                              , E = ji("gutter", r);
                            B && rt && ji("autoHeight", r) && "speed"in a && (l = "#" + we + "-mw{" + $i(y) + "}"),
                            ("edgePadding"in a || "gutter"in a) && (c = "#" + we + "-iw{" + Hi(v, E, p, y, _) + "}"),
                            J && lt && !Ct && ("fixedWidth"in a || "items"in a || St && "gutter"in a) && (u = "width:" + Fi(p, E, d) + ";"),
                            B && "speed"in a && (u += $i(y)),
                            u && (u = "#" + we + "{" + u + "}"),
                            ("fixedWidth"in a || St && "gutter"in a || !J && "items"in a) && (h += zi(p, E, d)),
                            "gutter"in a && (h += Ri(E)),
                            !J && "speed"in a && (B && (h += $i(y)),
                            q && (h += qi(y))),
                            h && (h = "#" + we + " > .tns-item{" + h + "}"),
                            (o = l + c + u + h) && Xt.insertRule("@media (min-width: " + r / 16 + "em) {" + o + "}", Xt.cssRules.length)
                        }
                }(),
                Wi();
                var ki = Ft ? J ? function() {
                    var t = he
                      , e = de;
                    t += Nt,
                    e -= Nt,
                    At ? (t += 1,
                    e -= 1) : St && (Pt + Lt) % (St + Lt) && (e -= 1),
                ...
                : function() {
                  ...
                  , Ti = J ? function() {
                    ...
                    l = s.indexOf("%") >= 0 ? "%" : "px",
                    s = s.replace(l, ""),
                    c = Number(t.style[e].replace(i, "").replace(n, "").replace(l, "")),
                    u = (s - c) / o * a,
            ...
            function Si() {
                for (var t = J ? ce - te : ce; t < 0; )
                    t += mt;
                return t % mt + 1
            }
            function Ai(t) {
                return t = t ? Math.max(0, Math.min(Ft ? mt - 1 : mt - Mt, t)) : 0,
                J ? t + te : t
            }
            function Li(t) {
                for (null == t && (t = ce),
            ...
            function Pi() {
                var t, e = Li();
                return t = De ? e : St || Ct ? Math.ceil((e + 1) * ei / mt - 1) : Math.floor(e / Mt),
                !Ft && J && ce === de && (t = ei - 1),
                t
            }
            function Oi() {
            ...
            function ji(e, i) {
                ...
                if (X)
                    for (var s in X)
                        i >= parseInt(s) && e in X[s] && (n = X[s][e]);
                return "slideBy" === e && "page" === n && (n = ji("items")),
            ...
            function Hi(t, e, i, n, s) {
                ...
                if (void 0 !== t) {
                    var r = t;
                    e && (r -= e),
                    o = lt ? "margin: 0 " + r + "px 0 " + t + "px;" : "margin: " + t + "px 0 " + r + "px 0;"
                } else if (e && !i) {
                    var a = "-" + e + "px";
                    o = "margin: 0 " + (lt ? a + " 0 0" : "0 " + a + " 0") + ";"
                }
                return !J && s && B && n && (o += $i(n)),
                o
            }
            function Fi(t, e, i) {
                return t ? (t + e) * ee + "px" : M ? M + "(" + 100 * ee + "% / " + i + ")" : 100 * ee / i + "%"
            }
            function zi(t, e, i) {
                var n;
                if (t)
            ...
            function Wi() {
                if (Di("autoHeight") || Ct || !lt) {
                    ...
                    g(t, (function(t) {
                        var e = t.src;
                        Gt || (e && e.indexOf("data:image") < 0 ? (t.src = "",
                        D(t, $e),
                        b(t, "loading"),
                        t.src = e) : ln(t))
                    }
            ...
            function Vi() {
                if (Ct && mt > 1) {
                    ...
                    !function e() {
                        ...
                        Math.abs(i - n) <= 1 ? Ui() : setTimeout((function() {
                            e()
                        }
                        ), 16)
                    }()
            ...
            function Yi() {
                if (yn(),
                ct.insertAdjacentHTML("afterbegin", '<div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">' + on() + "</span>  of " + mt + "</div>"),
                wt = ct.querySelector(".tns-liveregion .current"),
                je) {
                    var e = Vt ? "stop" : "start";
                    mi ? k(mi, {
                        "data-action": e
                    }) : t.autoplayButtonOutput && (ct.insertAdjacentHTML(Mi(t.autoplayPosition), '<button type="button" data-action="' + e + '">' + yi[0] + e + yi[1] + Yt[0] + "</button>"),
                ...
                if (Ie) {
                    if (Ze)
                        ...
                        for (var i = "", n = De ? "" : 'style="display:none"', s = 0; s < mt; s++)
                            i += '<button type="button" data-nav="' + s + '" tabindex="-1" aria-controls="' + we + '" ' + n + ' aria-label="' + ai + (s + 1) + '"></button>';
                ...
                Ne && (Ue || Qe && Ke || (ct.insertAdjacentHTML(Mi(t.controlsPosition), '<div class="tns-controls" aria-label="Carousel Navigation" tabindex="0"><button type="button" data-controls="prev" tabindex="-1" aria-controls="' + we + '">' + Bt[0] + '</button><button type="button" data-controls="next" tabindex="-1" aria-controls="' + we + '">' + Bt[1] + "</button></div>"),
                Ue = ct.querySelector(".tns-controls")),
                Qe && Ke || (Qe = Ue.children[0],
                Ke = Ue.children[1]),
                t.controlsContainer && k(Ue, {
                    "aria-label": "Carousel Navigation",
                    tabindex: "0"
                }),
                (t.controlsContainer || t.prevButton && t.nextButton) && k([Qe, Ke], {
                    "aria-controls": we,
                    tabindex: "-1"
                }),
                (t.controlsContainer || t.prevButton && t.nextButton) && (k(Qe, {
                    "data-controls": "prev"
                }),
                k(Ke, {
                    "data-controls": "next"
            ...
            function Qi() {
                ...
                Wt && D(ht, Me),
                Dt && D(e, Pe),
                "inner" === G ? ve.on("outerResized", (function() {
                    Xi(),
                    ve.emit("innerLoaded", ts())
                }
                )) : (X || St || Ct || zt || !lt) && D(i, {
                    resize: Ki
                }),
            ...
            function Xi(i) {
                if (yt) {
                    "outer" === G && ve.emit("outerResized", ts(i)),
                    gt = Oi();
                    var n, s = at, o = !1;
                    X && (Ji(),
                    (n = s !== at) && ve.emit("newBreakpointStart", ts(i)));
                    var r, a, l = Mt, c = _e, u = ke, h = Dt, d = Rt, p = $t, y = qt, v = Wt, _ = Vt, E = Qt, x = Kt, k = ce;
                    if (n) {
                        var T = St
                          , C = zt
                          , L = Bt
                    ...
                    xe && (n || St || Ct) && (ke = Gi()) !== u && (ke ? (An(Cn(Ai(0))),
                    en()) : (function() {
                        if (Te) {
                            if (At && I && (ut.style.margin = ""),
                            te)
                    ...
                    Rt !== d && (Rt ? Ue ? A(Ue) : (Qe && A(Qe),
                    Ke && A(Ke)) : Ue ? S(Ue) : (Qe && S(Qe),
                    Ke && S(Ke))),
                    $t !== p && ($t ? (A(Ze),
                    Zn()) : S(Ze)),
                    ...
                    n) {
                        ...
                        Rt && Bt !== L && (Qe.innerHTML = Bt[0],
                        Ke.innerHTML = Bt[1]),
                        mi && Yt !== O) {
                            var H = Vt ? 1 : 0
                              , F = mi.innerHTML
                              , z = F.length - O[H].length;
                            F.substring(z) === O[H] && (mi.innerHTML = F.substring(0, z) + Yt[H])
                        }
                    } else
                        Ot && (St || Ct) && (o = !0);
                    if ((a || St && !Ct) && (ei = Jn(),
                    Zn()),
                    (r = ce !== k) ? (ve.emit("indexChanged", ts()),
                    o = !0) : a ? r || pn() : (St || Ct) && (an(),
                    yn(),
                    sn()),
                    a && !J && function() {
                        for (var t = ce + Math.min(mt, Mt), e = ee; e--; ) {
                            var i = ft[e];
                            e >= ce && e < t ? (b(i, "tns-moving"),
                            i.style.left = 100 * (e - ce) / Mt + "%",
                            b(i, it),
                            w(i, ot)) : i.style.left && (i.style.left = "",
                            b(i, ot),
                            w(i, it)),
                            w(i, nt)
                        }
                    ...
                    !_e && !ke) {
                        if (n && !I && (At === N && Lt === M || (ut.style.cssText = Hi(At, Lt, St, jt, zt)),
                        lt)) {
            ...
            function Gi() {
                if (!St && !Ct)
                    return mt <= (Ot ? Mt - (Mt - 1) / 2 : Mt);
                var t = St ? (St + Lt) * mt : vt[mt]
                  , e = At ? Pt + 2 * At : Pt + Lt;
                return Ot && (e -= St ? (Pt - St) / 2 : (Pt - (vt[ce + 1] - vt[ce] - Lt)) / 2),
                t <= e
            }
            function Ji() {
                for (var t in at = 0,
            ...
            function rn(t) {
                null == t && (t = Cn());
                var e, i, n, s = ce;
                if (Ot || At ? (Ct || St) && (i = -(parseFloat(t) + At),
                n = i + Pt + 2 * At) : Ct && (i = vt[ce],
                n = i + Pt),
                Ct)
                    vt.forEach((function(t, o) {
                        o < ee && ((Ot || At) && t <= i + .5 && (s = o),
                        n - t >= .5 && (e = o))
                    }
                    ));
                else {
                    if (St) {
                        var o = St + Lt;
                        Ot || At ? (s = Math.floor(i / o),
                        e = Math.ceil(n / o - 1)) : e = s + Math.ceil(Pt / o) - 1
                    } else if (Ot || At) {
                        var r = Mt - 1;
                        if (Ot ? (s -= r / 2,
                        e = ce + r / 2) : e = ce + r,
            ...
            function dn(t, e) {
                return bt ? e() : (t.forEach((function(e, i) {
                    !Gt && e.complete && cn(e),
                    v(e, Be) && t.splice(i, 1)
                }
                )),
                t.length ? void s((function() {
                    dn(t, e)
                }
                )) : e())
            }
            ...
            function yn() {
                var t = rn()
                  ...
                  , i = t[1];
                g(ft, (function(t, n) {
                    n >= e && n <= i ? _(t, "aria-hidden") && (T(t, ["aria-hidden", "tabindex"]),
                    b(t, ze)) : _(t, "aria-hidden") || (k(t, {
                        "aria-hidden": "true",
                        tabindex: "-1"
                    }),
                    w(t, ze))
            ...
            function kn(t) {
                return null == t && (t = ce),
                Ct ? (Pt - (At ? Lt : 0) - (vt[t + 1] - vt[t] - Lt)) / 2 : St ? (Pt - St) / 2 : (Mt - 1) / 2
            }
            function Tn() {
                var t = Pt + (At ? Lt : 0) - (St ? (St + Lt) * ee : vt[ee]);
                return Ot && !Ft && (t = St ? -(St + Lt) * (ee - 1) - kn() : kn(ee - 1) - vt[ee - 1]),
                t > 0 && (t = 0),
                t
            }
            function Cn(t) {
            ...
            function Pn(t, e) {
                se && ki(),
                (ce !== ue || e) && (ve.emit("indexChanged", ts()),
            ...
            function Mn(t) {
                if (J || ge) {
                    ...
                    if (!t || !J && t.target.parentNode === ht || t.target === ht && On(t.propertyName) === On(oe)) {
                        if (!se) {
                            var n = ce;
                            ki(),
                            ce !== n && (ve.emit("indexChanged", ts()),
                            Sn())
                        }
                        "inner" === G && ve.emit("innerLoaded", ts()),
                        ge = !1,
            ...
            function Nn(t, e) {
                if (!ke)
                    if ("prev" === t)
                        ...
                        var i = Li()
                          , n = 0;
                        if ("first" === t ? n = -i : "last" === t ? n = J ? mt - Mt - i : mt - 1 - i : ("number" != typeof t && (t = parseInt(t)),
                        isNaN(t) || (e || (t = Math.max(0, Math.min(mt - 1, t))),
                        n = t - i)),
                        !J && n && Math.abs(n) < Mt) {
                            var s = n > 0 ? 1 : -1;
            ...
            function In(t, e) {
                ...
                if (Ht) {
                    if (ce === he && -1 === e)
                        return void Nn("last", t);
                    if (ce === de && 1 === e)
                        return void Nn("first", t)
                }
                e && (ce += Nt * e,
                Ct && (ce = Math.floor(ce)),
            ...
            function Un() {
                ...
                i = fe,
                n = !1,
                (s = Math.abs(90 - Math.abs(e))) >= 90 - i ? n = "horizontal" : s <= i && (n = "vertical"),
                n === t.axis;
                var e, i, n, s, o, r
            }
            function Yn(t) {
                ...
                _i.x = wi.x = e.clientX,
                _i.y = wi.y = e.clientY,
                J && (vi = parseFloat(ht.style[oe].replace(re, "")),
                xn(ht, "0s"))
            }
            function Qn(t) {
                if (Ei) {
                    ...
                    me && (qe = !0)),
                    ("boolean" != typeof t.cancelable || t.cancelable) && qe && t.preventDefault()
                }
            }
            function Kn(t) {
                if (me) {
                    ...
                    me) {
                        ...
                        var e = vi
                          , i = xi(_i, wi);
                        !lt || St || Ct ? (e += i,
                        e += "px") : (e += z ? i * Mt * 100 / ((Pt + Lt) * ee) : 100 * i / (Pt + Lt),
                        e += "%"),
                        ht.style[oe] = re + e + ae
                    }
                } else
                ...
                if (Ei) {
                    ...
                    if (Math.abs(n)) {
                        ...
                        J ? bi = s((function() {
                            ...
                            Pn(e, n),
                            ve.emit(Wn(e) ? "touchEnd" : "dragEnd", ts(e))
                        }
                        )) : me && In(e, n > 0 ? -1 : 1)
                    }
                }
                        ...
                        value: function(t, e) {
                            ...
                            !0 !== this.pause.status ? this.timeout = setTimeout((function() {
                                ...
                                i.timeout = setTimeout((function() {
                                    i.toggleBlinking(!1),
                                    e >= t.length ? i.doneTyping(t, e) : i.keepTyping(t, e, s),
